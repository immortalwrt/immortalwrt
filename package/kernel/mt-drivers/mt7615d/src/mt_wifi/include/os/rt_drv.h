...
#define PCI_UNMAP_SINGLE(_pAd, _ptr, _size, _dir)                              \
	linux_pci_unmap_single(((POS_COOKIE)(_pAd->OS_Cookie))->pci_dev, _ptr, \
			       _size, _dir)
 ...
 *   IN ULONG  Value);
 */
#define RTMP_SetPhysicalAddressLow(phy_addr, Value) (phy_addr = Value)
...
#define RTMP_SYS_IO_WRITE32(_R, _V) writel(_V, (void *)(_R))
	...
	defined(RALINK_2883) || defined(RTMP_RBUS_SUPPORT) || defined(MT76x2)
#define RTMP_IO_WRITE8(_A, _R, _V)                                             \
	{                                                                      \
		ULONG Val;                                                     \
		UCHAR _i;                                                      \
...
#define RTMP_OS_NETDEV_STATE_RUNNING(_pNetDev)                                 \
	(RtmpOSNetDevIsUp(_pNetDev) == TRUE)
...
#define SET_OS_PKT_DATAPTR RtmpOsPktDataPtrAssign

#define GET_OS_PKT_LEN(_pkt) (*(UINT32 *)((UCHAR *)_pkt + RTPktOffsetLen))

#define SET_OS_PKT_LEN RtmpOsPktLenAssign

#define GET_OS_PKT_CB(_pkt) ((UCHAR *)((UCHAR *)_pkt + RTPktOffsetCB))

#define GET_OS_PKT_NETDEV(_pkt) RtmpOsPktNetDevGet

#define OS_PKT_CLONED RtmpOsIsPktCloned

#define OS_PKT_COPY RtmpOsPktCopy

#define OS_PKT_TAIL_ADJUST RtmpOsPktTailAdjust

#define OS_PKT_HEAD_BUF_EXTEND RtmpOsPktHeadBufExtend

#define OS_PKT_TAIL_BUF_EXTEND RtmpOsPktTailBufExtend

#define OS_PKT_RESERVE RtmpOsPktReserve

#define OS_PKT_CLONE(_pAd, _pkt, _src, _flag) (_src = RtmpOsPktClone((_pkt)))
...
#define PACKET_CB_ASSIGN(_p, _offset) (*((UINT8 *)_p + RTPktOffsetCB + _offset))
