...
#define JapanChannelCheck(_ch)                                                 \
	((_ch == 52) || (_ch == 56) || (_ch == 60) || (_ch == 64))
...
BOOLEAN N_ChannelGroupCheck(RTMP_ADAPTER *pAd, UCHAR channel,
			    struct wifi_dev *wdev);
VOID ht_ext_cha_adjust(struct _RTMP_ADAPTER *pAd, UCHAR prim_ch, UCHAR *ht_bw,
...
INT32 ChannelFreqToGroup(IN UINT32 ChannelFreq);

BOOLEAN MTChGrpValid(IN CHANNEL_CTRL *ChCtrl);
