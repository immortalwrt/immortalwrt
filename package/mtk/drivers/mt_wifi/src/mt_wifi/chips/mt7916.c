 ...
 */
INT8 i1MT7916RxFeLossComp[RAM_BAND_NUM][MAX_ANTENNA_NUM];
UINT16 MT7916_DNL_CAL_GBAND_BW20_FREQ[] = {2412, 2442, 2472};
UINT16 MT7916_DNL_CAL_ABAND_BW20_FREQ[] = {
	4960, 5060,/* Group 1 */
	5180, 5240,/* Group 2 */
	5260, 5320,/* Group 3 */
	5340, 5480,/* Group 4 */
	...
	5660, 5720,/* Group 7 */
	5785, 5845 /* Group 8 */};
UINT16 MT7916_DNL_CAL_BW20_FREQ[] = {
	2412, 2442, 2472,
	4960, 5060, 5180, 5240, 5260, 5320, 5340, 5480, 5500, 5560, 5580, 5640, 660, 5720, 5785, 5845};

UINT16 MT7916_DNL_CAL_GBAND_BW20_CH[] = {1, 7, 13};
UINT16 MT7916_DNL_CAL_ABAND_BW20_CH[] = {
	192,  12,  36,  48,  52,  64,  68,  96, 100, 112, 116, 128, 132, 144, 157, 169};
UINT16 MT7916_DNL_CAL_BW20_CH[] = {
	  1,   7,  13, 192,  12,  36,  48,  52,  64,  68,  96, 100, 112, 116, 128, 132, 144, 157, 169};

UINT16 MT7916_DNL_CAL_GBAND_BW20_SIZE = (sizeof(MT7916_DNL_CAL_GBAND_BW20_FREQ) / sizeof(UINT16));
UINT16 MT7916_DNL_CAL_ABAND_BW20_SIZE = (sizeof(MT7916_DNL_CAL_ABAND_BW20_FREQ) / sizeof(UINT16));
UINT16 MT7916_DNL_CAL_BW20_FREQ_SIZE  = (sizeof(MT7916_DNL_CAL_BW20_FREQ) / sizeof(UINT16));

UINT16 MT7916_DNL_CAL_GBAND_BW20_CH_SIZE = (sizeof(MT7916_DNL_CAL_GBAND_BW20_CH) / sizeof(UINT16));
UINT16 MT7916_DNL_CAL_ABAND_BW20_CH_SIZE = (sizeof(MT7916_DNL_CAL_ABAND_BW20_CH) / sizeof(UINT16));
UINT16 MT7916_DNL_CAL_B20_CH_SIZE        = (sizeof(MT7916_DNL_CAL_BW20_CH) / sizeof(UINT16));
...
static struct rtmp_spe_map mt7916_spe_map[] = {
	/* All */
	{0x0, 0},
	{0xf, 0},
	/* 1 Ant */
...
UINT16 MT7916_PER_CH_A5_BW20_FREQ[] = {
	5180, 5200, 5220, 5240, 5260, 5280, 5300, 5320,
	5500, 5520, 5540, 5560, 5580, 5600, 5620, 5640,
	5660, 5680, 5700, 5720, 5745, 5765, 5785, 5805,
	5825, 5845, 5865, 5885};

UINT16 MT7916_PER_CH_A5_BW160_FREQ[] = {
	5250, 5570, 5815};

UINT16 MT7916_PER_CH_A5_BW20_BW160_FREQ[] = {
	5180, 5200, 5220, 5240, 5260, 5280, 5300, 5320,
	5500, 5520, 5540, 5560, 5580, 5600, 5620, 5640,
	5660, 5680, 5700, 5720, 5745, 5765, 5785, 5805,
	5825, 5845, 5865, 5885,
...
UINT16 MT7916_PER_CH_A5_BW20[] = {
	 36,  40,  44,  48,  52,  56,  60,  64,
	100, 104, 108, 112, 116, 120, 124, 128,
	132, 136, 140, 144, 149, 153, 157, 161,
	165, 169, 173, 177};

UINT16 MT7916_PER_CH_A5_BW160[] = {
	 50, 114, 163};

UINT16 MT7916_PER_CH_A5_BW20_BW160[] = {
	 36,  40,  44,  48,  52,  56,  60,  64,
	100, 104, 108, 112, 116, 120, 124, 128,
	132, 136, 140, 144, 149, 153, 157, 161,
	165, 169, 173, 177,
...
UINT16 MT7916_PER_CH_A6_BW20_FREQ[] = {
...
UINT16 MT7916_PER_CH_A6_BW160_FREQ[] = {
	6025, 6185, 6345, 6505, 6665, 6825, 6985};

UINT16 MT7916_PER_CH_A6_BW20_BW160_FREQ[] = {
	5955, 5975, 5995, 6015, 6035, 6055, 6075, 6095,
	6115, 6135, 6155, 6175, 6195, 6215, 6235, 6255,
	6275, 6295, 6315, 6335, 6355, 6375, 6395, 6415,
	6435, 6455, 6475, 6495, 6515, 6535, 6555, 6575,
...
UINT16 MT7916_PER_CH_A6_BW160[] = {
	 15,  47,  79, 111, 143, 175, 207};

UINT16 MT7916_PER_CH_A6_BW20_BW160[] = {
	  1,   5,   9,  13,  17,  21,  25,  29,
	 33,  37,  41,  45,  49,  53,  57,  61,
	 65,  69,  73,  77,  81,  85,  89,  93,
	 97, 101, 105, 109, 113, 117, 121, 125,
...
UINT16 MT7916_PER_CH_G_BW20_FREQ[] = {
	2422, 2442, 2462};

UINT16 MT7916_PER_CH_G_BW20[] = {
	  3,   7,  11};

UINT16 MT7916_PER_CH_A5_BW20_BW160_FREQ_SIZE = sizeof(MT7916_PER_CH_A5_BW20_BW160_FREQ) / sizeof(UINT16);
UINT16 MT7916_PER_CH_A6_BW20_BW160_FREQ_SIZE = sizeof(MT7916_PER_CH_A6_BW20_BW160_FREQ) / sizeof(UINT16);
UINT16 MT7916_PER_CH_G_BW20_FREQ_SIZE  = (sizeof(MT7916_PER_CH_G_BW20_FREQ) / sizeof(UINT16));

UINT16 MT7916_PER_CH_A5_BW20_BW160_SIZE = sizeof(MT7916_PER_CH_A5_BW20_BW160) / sizeof(UINT16);
UINT16 MT7916_PER_CH_A6_BW20_BW160_SIZE = sizeof(MT7916_PER_CH_A6_BW20_BW160) / sizeof(UINT16);
UINT16 MT7916_PER_CH_A5_BW20_SIZE =  sizeof(MT7916_PER_CH_A5_BW20) / sizeof(UINT16);
UINT16 MT7916_PER_CH_A6_BW20_SIZE =  sizeof(MT7916_PER_CH_A6_BW20) / sizeof(UINT16);

UINT16 MT7916_PER_CH_G_BW20_SIZE    = (sizeof(MT7916_PER_CH_G_BW20) / sizeof(UINT16));

#endif /* PRE_CAL_MT7916_SUPPORT */


/* SKU Table definitions */
UINT8 MT7916_SINGLE_SKU_FILL_TABLE_LENGTH[] = {
...
#ifdef PRE_CAL_MT7916_SUPPORT
void mt7916_apply_dpd_flatness_data(RTMP_ADAPTER *pAd, MT_SWITCH_CHANNEL_CFG SwChCfg)
{
	USHORT			doCal1 = 0;
	UINT8			i = 0;
	UINT8			Band = 0;
...
#ifdef PRE_CAL_MT7916_SUPPORT
    mt7916_apply_dpd_flatness_data(pAd, SwChCfg);
#endif
...
static struct _kfree_def ddie_def[] = {
	{20, {0x30, 0x31, 0x34, 0x35, 0x36, 0x38, 0x3c, 0x3a, 0x3d, 0x44,
		  0x46, 0xc8, 0xc9, 0xca, 0xcb, 0xcc, 0xcd, 0xce, 0xcf, 0xe0}
	}
};
...

{
	UINT8 kfree_cnt = 0, loop = 0;
	struct _kfree_def *kfree_def = NULL;
	UCHAR ee_9a6 = 0, ee_9a8 = 0;

	MTWF_DBG(ad, DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, "\n");

	/* D-Die version */
	//cal_free_data_get_from_addr(ad, 0xE0);
	//kfree_def = &ddie_def[ad->EEPROMImage[0xE0]-1];
	kfree_def = &ddie_def[0];
	kfree_cnt = kfree_def->count;
	for (loop = 0; loop < kfree_cnt; loop++)
	...
	for (loop = 0; loop < kfree_cnt; loop++) {
		...
		/* workaround 2K FT cal. fail samples max output code is 42 */
		if (kfree_def->offsets[loop] == 0x9a8) {
			ee_9a8 = (ad->EEPROMImage[0x9a8] & BITS(0, 6));
			ee_9a6 = ((ad->EEPROMImage[0x9a6] & BITS(3, 6)) >> 3);

			if (ee_9a8 < 42 && ee_9a6 == 4)
				ad->EEPROMImage[0x9a8] = (ee_9a8 + 19) | BIT(7);
			else if (ee_9a8 < 42 && ee_9a6 == 8)
				ad->EEPROMImage[0x9a8] = (ee_9a8 + 38) | BIT(7);
			else if (ee_9a8 < 42 && ee_9a6 == 12)
				ad->EEPROMImage[0x9a8] = (ee_9a8 + 57) | BIT(7);

			MTWF_DBG(ad, DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,
				 "\t\t%s Replace: 0x9a8=0x%x, 0x9a6=0x%x\n", __func__,
				  ad->EEPROMImage[0x9a8], ad->EEPROMImage[0x9a6]);
		}
	}
}
	...
	EEPROM_ANTENNA_STRUC *pAntenna)
{
	...
	MTWF_DBG(pAd, DBG_CAT_HW, DBG_SUBCAT_ALL, DBG_LVL_INFO,
	"%s() value = 0x%x, TxPath = %d, RxPath = %d\n",
...
#ifdef NEED_ROM_PATCH
#ifndef CONFIG_MT7916_FW_BIN_LOAD
	ctrl->patch_profile[WM_CPU].source.header_ptr = mt7916_rom_patch_e1;
	ctrl->patch_profile[WM_CPU].source.header_len = sizeof(mt7916_rom_patch_e1);
#endif /* !CONFIG_MT7916_FW_BIN_LOAD */
	ctrl->patch_profile[WM_CPU].source.bin_name = MT7916_ROM_PATCH_BIN_FILE_NAME_E1;
	MTWF_PRINT("using E1 ROM patch\n");
#endif /* NEED_ROM_PATCH */
#ifndef CONFIG_MT7916_FW_BIN_LOAD
	ctrl->fw_profile[WM_CPU].source.header_ptr = MT7916_FirmwareImage_E1;
	ctrl->fw_profile[WM_CPU].source.header_len = sizeof(MT7916_FirmwareImage_E1);
#endif /* !CONFIG_MT7916_FW_BIN_LOAD */
	ctrl->fw_profile[WM_CPU].source.bin_name = MT7916_BIN_FILE_NAME_E1;
	MTWF_PRINT("using E1 RAM\n");
#ifndef CONFIG_MT7916_FW_BIN_LOAD
	ctrl->fw_profile[WA_CPU].source.header_ptr = MT7916_WA_FirmwareImage;
	ctrl->fw_profile[WA_CPU].source.header_len = sizeof(MT7916_WA_FirmwareImage);
#endif /* !CONFIG_MT7916_FW_BIN_LOAD */

	ctrl->fw_profile[WA_CPU].source.bin_name = MT7916_WA_BIN_FILE_NAME;
}

static INT32 mt7916_kick_out_fwdl_msg(PRTMP_ADAPTER pAd, struct cmd_msg *msg)
{
...
static UINT32 mt7916_get_wf_path_comb(
	struct _RTMP_ADAPTER *pAd,
	UINT8 band_idx,
...
static UINT32 mt7916_get_rx_stat_band(
	struct _RTMP_ADAPTER *pAd,
	UINT8 band_idx,
	UINT8 blk_idx,
...
static UINT32 mt7916_get_rx_stat_path(
	struct _RTMP_ADAPTER *pAd,
	UINT8 band_idx,
	UINT8 blk_idx,
...
static UINT32 mt7916_get_rx_stat_user(
	struct _RTMP_ADAPTER *pAd,
	UINT8 band_idx,
	UINT8 blk_idx,
...
static UINT32 mt7916_get_rx_stat_comm(
	struct _RTMP_ADAPTER *pAd,
	UINT8 band_idx,
	UINT8 blk_idx,
...
static UINT32 mt7916_get_rx_stat(
	struct _RTMP_ADAPTER *pAd,
	UCHAR band_idx,
...
static UINT32 mt7916_get_rx_fe_loss(
	struct _RTMP_ADAPTER *pAd,
	UCHAR band_idx,
	UCHAR path_idx)
{
...
static UINT32 mt7916_rxv_entry_hdr_parser(struct _RTMP_ADAPTER *pAd, VOID *rxv_entry, RXV_ENTRY_HDR *rxv_entry_hdr)
{
	UINT32 *ptr = NULL;
...
static UINT32 mt7916_rxv_pkt_hdr_parser(struct _RTMP_ADAPTER *pAd, VOID *rxv_pkt, RXV_PKT_HDR *rxv_pkt_hdr)
{
	UINT32 *ptr = NULL;
...
static UINT32 mt7916_rxv_get_byte_cnt(
	struct _RTMP_ADAPTER *pAd,
	UINT8 band_idx,
	UINT32 *byte_cnt)
{
...
static UINT32 mt7916_rxv_get_content(
	struct _RTMP_ADAPTER *pAd,
	UINT8 band_idx,
	PVOID *content)
{
...
static UINT32 mt7916_rxv_raw_data_show(struct _RTMP_ADAPTER *pAd, UINT8 band_idx)
{
...
static UINT32 mt7916_rxv_info_show(struct _RTMP_ADAPTER *pAd, UINT8 band_idx)
{
	return FALSE;

}

static UINT32 mt7916_rxv_stat_reset(struct _RTMP_ADAPTER *pAd, UINT8 band_idx)
{
...
static UINT32 mt7916_rxv_cap_init(RTMP_ADAPTER *pAd)
{
	RTMP_CHIP_CAP *cap = hc_get_chip_cap(pAd->hdev_ctrl);
...
static UINT32 mt7916_rxv_entry_parse(struct _RTMP_ADAPTER *pAd, VOID *Data)
{
	...
	for (i = WF0; i < WF_NUM; i++) {
		if (rx_stat->RCPI[i] == 0xFF) {
			...
			rx_stat->RCPI[i] = rx_stat->RCPI[i] + i1MT7916RxFeLossComp[band_idx][i];
...
static UINT32 mt7916_rxv_content_len(struct _RTMP_ADAPTER *pAd, UINT8 type_mask, UINT8 rxv_sta_cnt, UINT16 *len)
{
	RTMP_CHIP_CAP *cap = hc_get_chip_cap(pAd->hdev_ctrl);
...
static UINT32 mt7916_rxv_dump_start(struct _RTMP_ADAPTER *pAd)
{
...
static UINT32 mt7916_rxv_dump_stop(struct _RTMP_ADAPTER *pAd)
{
	pAd->rxv_dump_ctrl.enable = false;
	return 0;
}

static UINT32 mt7916_rxv_dump_link_list_instl(
...
static UINT32 mt7916_rxv_dump_link_list_remv(struct _RTMP_ADAPTER *pAd, VOID *ptr, RXV_DUMP_LIST_TYPE type)
{
	RXV_DUMP_ENTRY_CONTENT *rxv_dump_entry_content = NULL;
	RXV_DUMP_BASIC_ENTRY *rxv_dump_basic_entry = NULL;
	RXV_DUMP_ENTRY *rxv_dump_entry = NULL;
...
static UINT32 mt7916_rxv_dump_buf_alloc(struct _RTMP_ADAPTER *pAd, UINT8 type_mask)
{
	INT32 ret = 0;
	...
	for (entry_idx = 0; entry_idx < dump_entry_num; entry_idx++) {
		...
		ret = mt7916_rxv_dump_link_list_instl(pAd,
...
static UINT32 mt7916_rxv_dump_buf_clear(struct _RTMP_ADAPTER *pAd)
{
	UINT32 ret = 0;
	...
	DlListForEachSafe(rxv_dump_entry, rxv_dump_entry_tmp,
		...
		DlListForEachSafe(rxv_dump_basic_entry, rxv_dump_basic_entry_tmp,
			...
			DlListForEachSafe(rxv_dump_entry_content, rxv_dump_entry_content_tmp,
				...
				ret = mt7916_rxv_dump_link_list_remv(pAd,
			...
			ret = mt7916_rxv_dump_link_list_remv(pAd, rxv_dump_basic_entry, RXV_DUMP_LIST_TYPE_BASIC_ENTRY);
			if (ret)
				goto error0;
		}
		...
		ret = mt7916_rxv_dump_link_list_remv(pAd, rxv_dump_entry, RXV_DUMP_LIST_TYPE_ENTRY);
		if (ret)
			goto error0;
	}
...
static UINT32 mt7916_rxv_dump_update(struct _RTMP_ADAPTER *pAd, VOID *rxv_pkt, UINT8 rxv_cnt)
{
	UINT32 ret = 0;
	...
	for (rxv_idx = 0; rxv_idx < rxv_cnt; rxv_idx++) {
		...
		mt7916_rxv_entry_hdr_parser(pAd, ptr, &rxv_entry_hdr);
		...
		for (type_idx = 0; type_idx < RXV_CONTENT_NUM; type_idx++) {
			mt7916_rxv_content_len(pAd, BIT(type_idx), 1, &len);
			len_byte = len << 2;
			...
			if (type_mask & BIT(type_idx)) {
				...
				ret = mt7916_rxv_dump_link_list_instl(pAd, rxv_dump_basic_entry_list,
				...
				if (rxv_dump_basic_entry_curr) {
					...
					if (data_list) {
						for (user_idx = 0; user_idx < user_num; user_idx++) {
							...
							/* install basic entry to list */
							ret = mt7916_rxv_dump_link_list_instl(pAd, data_list,
									&rxv_dump_entry_content, RXV_DUMP_LIST_TYPE_CONTENT);
							if (ret) {
								os_free_mem(rxv_dump_entry_content.content);
								rxv_dump_entry_content.content = NULL;
...
static UINT32 mt7916_rxv_dump_show_list(struct _RTMP_ADAPTER *pAd)
{
	DL_LIST *rxv_dump_entry_list = NULL, *rxv_dump_basic_entry_list = NULL, *data_list = NULL;
	RXV_DUMP_ENTRY_CONTENT *rxv_dump_entry_content = NULL, *rxv_dump_entry_content_tmp = NULL;
	RXV_DUMP_BASIC_ENTRY *rxv_dump_basic_entry = NULL, *rxv_dump_basic_entry_tmp = NULL;
...
static UINT32 mt7916_rxv_dump_user_content_compose(struct _RTMP_ADAPTER *pAd, DL_LIST *data_list, UINT8 user_idx,
...
static UINT32 mt7916_rxv_dump_type_detail_content_compose(
	struct _RTMP_ADAPTER *pAd,
	UINT8 usr_num,
	DL_LIST *data_list,
	...
	UINT32 *len)
{
	...
	*len += sizeof(usr_content_len);
	...
	for (user_idx = 0; user_idx < usr_cnt; user_idx++) {
		mt7916_rxv_dump_user_content_compose(pAd, data_list, user_idx, ptr, &usr_content_len);
		*len += usr_content_len;
		ptr += usr_content_len;
...
static UINT32 mt7916_rxv_dump_type_content_compose(
	struct _RTMP_ADAPTER *pAd,
	...
	UINT32 *len)
{
	...
	*len += sizeof(type_detail_content_len);
	...
	mt7916_rxv_dump_type_detail_content_compose(pAd,
...
static UINT32 mt7916_rxv_dump_rxv_content_compose(
	struct _RTMP_ADAPTER *pAd,
	UINT8 entry_idx,
	VOID *rxv_content,
	UINT32 *len)
	...
	*len += sizeof(type_cnt);
	...
	DlListForEachSafe(rxv_dump_basic_entry, rxv_dump_basic_entry_tmp,
		rxv_dump_basic_entry_list, RXV_DUMP_BASIC_ENTRY, list) {
			...
			mt7916_rxv_dump_type_content_compose(pAd, rxv_dump_basic_entry_list,
...
static UINT32 mt7916_rxv_dump_show_rpt(struct _RTMP_ADAPTER *pAd)
{
	UINT32 ret = 0;
	RTMP_CHIP_CAP *cap = hc_get_chip_cap(pAd->hdev_ctrl);
	...
	for (idx = ring_idx - valid_entry_num; idx < ring_idx; idx++) {
		...
		mt7916_rxv_dump_rxv_content_compose(pAd, entry_idx, ptr, &len);
...
static UINT32 mt7916_rxv_data_dump(struct _RTMP_ADAPTER *pAd, VOID *Data, UINT32 rxv_cnt, UINT32 rxv_byte_cnt)
{
	...
	mt7916_rxv_dump_update(pAd, Data, rxv_cnt);

	return 0;
}

static UINT32 mt7916_rxv_packet_parse(struct _RTMP_ADAPTER *pAd, VOID *Data)
{
	...
	mt7916_rxv_pkt_hdr_parser(pAd, pbuf, &rxv_pkt_hdr);

	MTWF_DBG(pAd, DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,
		"RxV Report: RxvCnt: %d, ByteCnt: %d\n",
		 rxv_pkt_hdr.rxv_cnt, rxv_pkt_hdr.rx_byte_cnt);

	mt7916_rxv_data_dump(pAd, Data, rxv_pkt_hdr.rxv_cnt, rxv_pkt_hdr.rx_byte_cnt);
...
static VOID mt7916_set_mgmt_pkt_txpwr_prctg(RTMP_ADAPTER *pAd,	struct wifi_dev *wdev, UINT8 prctg)
{
...
static VOID mt7916_rssi_get(RTMP_ADAPTER *pAd, UINT16 Wcid, CHAR *RssiSet)
{
...
#if defined(CONFIG_WLAN_SERVICE)
static INT32 mt7916_ate_set_test_mode_dnlk(RTMP_ADAPTER *pAd, UINT8 band_idx)
{
	...
	if (band_idx == 0)
		ch_size = MT7916_DNL_CAL_GBAND_BW20_CH_SIZE;
	else
		ch_size = MT7916_DNL_CAL_ABAND_BW20_CH_SIZE;
...
#ifdef PRE_CAL_MT7916_SUPPORT
INT32 mt7916_ate_group_prek(RTMP_ADAPTER *pAd, UINT8 op)
{
	USHORT doCal1 = 0;
	RTMP_CHIP_CAP *cap = hc_get_chip_cap(pAd->hdev_ctrl);
...
INT32 mt7916_ate_dpd_prek(RTMP_ADAPTER *pAd, UINT8 op)
{
	UINT8                 i = 0;
	USHORT                doCal1 = 0;
	MT_SWITCH_CHANNEL_CFG ch_cfg;
	...
	if (op == PREK_DPD_CLEAN) {
		...
		/* Clear TXDPD Image */
		pAd->TxDPDOfst = 0;
		RTMPZeroMemory(pAd->TxDPDImage + cap->prek_ee_info.dpd_flash_offset_a6_begin, cap->prek_ee_info.dpd_cal_6g_total_size);
...
VOID mt7916_update_mib_bucket(RTMP_ADAPTER *pAd)
{
	UCHAR i = 0;
	UCHAR curr_idx = 0;
...
VOID mt7916_ctrl_rxv_group(RTMP_ADAPTER *ad, UINT8 band_idx, UINT8 group, BOOLEAN enable)
{
...
UCHAR *mt7916_get_default_bin_image(RTMP_ADAPTER *ad)
{
	...
	if (multi_inf_get_idx(ad) == 0) {
		...
		chip_cap->EEPROM_DEFAULT_BIN_SIZE = sizeof(MT7916_E2PImage_ePAeLNA);
		chip_cap->EFUSE_BUFFER_CONTENT_SIZE = sizeof(MT7916_E2PImage_ePAeLNA);
		return MT7916_E2PImage_ePAeLNA;
#elif defined(CONFIG_FIRST_IF_IPAELNA)
		MTWF_PRINT("Use 1st iPAeLNA default bin.\n");
		chip_cap->EEPROM_DEFAULT_BIN_SIZE = sizeof(MT7916_E2PImage_iPAeLNA);
		chip_cap->EFUSE_BUFFER_CONTENT_SIZE = sizeof(MT7916_E2PImage_iPAeLNA);
		return MT7916_E2PImage_iPAeLNA;
#elif defined(CONFIG_FIRST_IF_EPAILNA)
		MTWF_PRINT("Use 1st ePAiLNA default bin.\n");
		chip_cap->EEPROM_DEFAULT_BIN_SIZE = sizeof(MT7916_E2PImage_ePAiLNA);
		chip_cap->EFUSE_BUFFER_CONTENT_SIZE = sizeof(MT7916_E2PImage_ePAiLNA);
...
#endif /* MULTI_INF_SUPPORT */
	{
		...
		return MT7916_E2PImage_ePAeLNA;
#elif defined(CONFIG_FIRST_IF_IPAELNA)
		MTWF_PRINT("Use the default iPAeLNA bin image!\n");
		chip_cap->EEPROM_DEFAULT_BIN_SIZE = sizeof(MT7916_E2PImage_iPAeLNA);
		chip_cap->EFUSE_BUFFER_CONTENT_SIZE = sizeof(MT7916_E2PImage_iPAeLNA);
		return MT7916_E2PImage_iPAeLNA;
#elif defined(CONFIG_FIRST_IF_EPAILNA)
		MTWF_PRINT("Use the default ePAiLNA bin image!\n");
		chip_cap->EEPROM_DEFAULT_BIN_SIZE = sizeof(MT7916_E2PImage_ePAiLNA);
		chip_cap->EFUSE_BUFFER_CONTENT_SIZE = sizeof(MT7916_E2PImage_ePAiLNA);
		return MT7916_E2PImage_ePAiLNA;
#else
...
INT32 mt7916_get_default_bin_image_file(RTMP_ADAPTER *ad, RTMP_STRING *path, BOOLEAN fgBinMode)
{
	INT ret;
	...
	} else {/* fill default for flash mode */
		ret = snprintf(path, 100, "%s", MT7916_EEPROM_DEFAULT_FILE_PATH);
	}
	...
	if (!fgBinMode)
		MTWF_PRINT("if %s file does not exist, use header file\n", path);

	return 0;
}

INT32 mt7916_get_prek_image_file(RTMP_ADAPTER *ad, RTMP_STRING *path)
{
	INT ret;
...
UINT32 mt7916_get_efuse_free_blk_num(RTMP_ADAPTER *ad, UINT8 blk_section)
{
	UINT32 ret = 0;
...
static VOID fwdl_datapath_setup(RTMP_ADAPTER *pAd, BOOLEAN init)
{
	...
	if (init == TRUE) {
		...
		ops->kick_out_cmd_msg = mt7916_kick_out_fwdl_msg;
	} else {
...
static VOID init_dev_nick_name(RTMP_ADAPTER *ad)
{
	...
	ret = snprintf((RTMP_STRING *) ad->nickname, sizeof(ad->nickname), "mt7916_sta");
...
static VOID set_rid_value(struct pci_hif_chip *pci_hif, UINT32 rid)
{
...
static INT hif_init_WFDMA(RTMP_ADAPTER *pAd)
{
...
#ifdef CONFIG_WTBL_MISS_DVT
		RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_PCIE1_SUBSYS2HOST_INT_ENA_ADDR, &val);
		val |= WF_WFDMA_HOST_DMA0_PCIE1_SUBSYS2HOST_INT_ENA_mac_int_ena_0_MASK;
		RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_PCIE1_SUBSYS2HOST_INT_ENA_ADDR, val);
#endif /*  CONFIG_WTBL_MISS_DVT */
	}
	...
	val |= 0x12 << WF_WFDMA_EXT_WRAP_CSR_WED_RING_CONTROL_IDX_WED_TX_RING0_CONTROL_IDX_SHFT;
	...
	val |= 0x13 << WF_WFDMA_EXT_WRAP_CSR_WED_RING_CONTROL_IDX_WED_TX_RING1_CONTROL_IDX_SHFT;
	RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_EXT_WRAP_CSR_WED_RING_CONTROL_IDX_ADDR, val);

	RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_EXT_WRAP_CSR_WED_RING_CONTROL_IDX_ADDR, &val);
	val &= ~WF_WFDMA_EXT_WRAP_CSR_WED_RING_CONTROL_IDX_WED_RX_RING1_CONTROL_IDX_MASK;
	val |= 0x2 << WF_WFDMA_EXT_WRAP_CSR_WED_RING_CONTROL_IDX_WED_RX_RING1_CONTROL_IDX_SHFT;
	RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_EXT_WRAP_CSR_WED_RING_CONTROL_IDX_ADDR, val);

	if (pAd->CommonCfg.whnat_en) {
		/*Enable HW CTXD*/
		if (MTK_REV_GTE(pAd, MT7916, MT7916E2)) {
			RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_CSR_WFDMA_DUMMY_REG_ADDR, &val);
			val |= (1 << WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_CSR_WFDMA_DUMMY_REG_SHFT);
			RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_CSR_WFDMA_DUMMY_REG_ADDR, val);

			RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_CTXD_TIMEOUT_ADDR, &val);
			val &= ~WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_CTXD_TIMEOUT_MASK;
			val |= 0xa << WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_CTXD_TIMEOUT_SHFT;
			RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_CTXD_TIMEOUT_ADDR, val);

		} else {
			RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_CTXD_TIMEOUT_ADDR, &val);
			val &= ~WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_CTXD_TIMEOUT_MASK;
			val |= 0xFF << WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_CTXD_TIMEOUT_SHFT;
			RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_CTXD_TIMEOUT_ADDR, val);

			/*Delay tick set to 0xFFFF, which is about 3449us*/
			RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_EXT_WRAP_CSR_DLY_INT_TICK_THRES_ADDR, 0xFFFF);
		}

		RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_CTXD_CASCADE_NUM_ADDR, &val);
		val &= ~WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_CTXD_CASCADE_NUM_MASK;
		val |= 0x0 << WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_CTXD_CASCADE_NUM_SHFT;
		RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_CTXD_CASCADE_NUM_ADDR, val);

		RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND1_CTXD_RING_IDX_ADDR, &val);
		val &= ~WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND1_CTXD_RING_IDX_MASK;
		val |= 0x13 << WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND1_CTXD_RING_IDX_SHFT;
		RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND1_CTXD_RING_IDX_ADDR, val);

		RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND1_CTXD_EN_ADDR, &val);
		val &= ~WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND1_CTXD_EN_MASK;
		val |= 0x1 << WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND1_CTXD_EN_SHFT;
		RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND1_CTXD_EN_ADDR, val);

		RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND0_CTXD_RING_IDX_ADDR, &val);
		val &= ~WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND0_CTXD_RING_IDX_MASK;
		val |= 0x12 << WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND0_CTXD_RING_IDX_SHFT;
		RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND0_CTXD_RING_IDX_ADDR, val);

		RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND0_CTXD_EN_ADDR, &val);
		val &= ~WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND0_CTXD_EN_MASK;
		val |= 0x1 << WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND0_CTXD_EN_SHFT;
		RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_CTXD_CFG_CSR_BAND1_CTXD_EN_ADDR, val);

		RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_EXT1_CSR_TX_FCTRL_MODE_ADDR, &val);
		val &= ~WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_EXT1_CSR_TX_FCTRL_MODE_MASK;
		val |= 0x1 << WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_EXT1_CSR_TX_FCTRL_MODE_SHFT;
		RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_GLO_CFG_EXT1_CSR_TX_FCTRL_MODE_ADDR, val);

	}
#endif
	RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_EXT_WRAP_CSR_WFDMA_MSI_CONFIG_ADDR, &val);
	val |= WF_WFDMA_EXT_WRAP_CSR_WFDMA_MSI_CONFIG_msi_deassert_tmr_en_MASK;
	val &= ~WF_WFDMA_EXT_WRAP_CSR_WFDMA_MSI_CONFIG_msi_deassert_tmr_ticks_MASK;
	val |= 64 << WF_WFDMA_EXT_WRAP_CSR_WFDMA_MSI_CONFIG_msi_deassert_tmr_ticks_SHFT;
	RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_EXT_WRAP_CSR_WFDMA_MSI_CONFIG_ADDR, val);
#ifdef CONFIG_WIFI_MSI_SUPPORT
	{
		if (master_hif_chip->is_msi) {
			RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_EXT_WRAP_CSR_WFDMA_HOST_CONFIG_ADDR, &val);
			val &= ~WF_WFDMA_EXT_WRAP_CSR_WFDMA_HOST_CONFIG_pcie0_msi_num_MASK;
			/* 2'h0: 1MSI , 2'h1: 2MSI , 2'h2: 4MSI , 2'h3: 8MSI */
			val |= 0x3 << WF_WFDMA_EXT_WRAP_CSR_WFDMA_HOST_CONFIG_pcie0_msi_num_SHFT;
			if (MT7916_get_rid_value() != DEFAULT_RID) {
				val &= ~WF_WFDMA_EXT_WRAP_CSR_WFDMA_HOST_CONFIG_pcie1_msi_num_MASK;
				val |= 0x2 << WF_WFDMA_EXT_WRAP_CSR_WFDMA_HOST_CONFIG_pcie1_msi_num_SHFT;
				val &= ~WF_WFDMA_EXT_WRAP_CSR_WFDMA_HOST_CONFIG_pdma_per_band_MASK;
				val |= 0x1 << WF_WFDMA_EXT_WRAP_CSR_WFDMA_HOST_CONFIG_pdma_per_band_SHFT;
			}
			RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_EXT_WRAP_CSR_WFDMA_HOST_CONFIG_ADDR, val);
			...
			if (MT7916_get_rid_value() != DEFAULT_RID) {
				RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_EXT_WRAP_CSR_WFDMA_MSI_CONFIG_ADDR, &val);
				val &= ~WF_WFDMA_EXT_WRAP_CSR_WFDMA_MSI_CONFIG_pcie0_msi_ack_mode_MASK;
				val |= 0x00000004;
				val &= ~WF_WFDMA_EXT_WRAP_CSR_WFDMA_MSI_CONFIG_pcie1_msi_ack_mode_MASK;
				val |= 0x00000800;
				RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_EXT_WRAP_CSR_WFDMA_MSI_CONFIG_ADDR, val);
			} else {
				RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_EXT_WRAP_CSR_WFDMA_MSI_CONFIG_ADDR, &val);
			...
			/* delay interrupt */
			RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_ADDR, &val);
			val &= ~WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_PRI0_MAX_PTIME_MASK;
			val |= (2 << WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_PRI0_MAX_PTIME_SHFT);
			val &= ~WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_PRI0_MAX_PINT_MASK;
			val |= (127 << WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_PRI0_MAX_PINT_SHFT);
			val |= (1 << WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_PRI0_DLY_INT_EN_SHFT);
			RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_ADDR, val);

			if (MT7916_get_rid_value() != DEFAULT_RID) {
				RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_PRI_DLY_INT_CFG0_ADDR, &val);
				val &= ~WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_PRI_DLY_INT_CFG0_PRI1_MAX_PTIME_MASK;
				val |= (2 << WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_PRI_DLY_INT_CFG0_PRI1_MAX_PTIME_SHFT);
				val &= ~WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_PRI_DLY_INT_CFG0_PRI1_MAX_PINT_MASK;
				val |= (127 << WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_PRI_DLY_INT_CFG0_PRI1_MAX_PINT_SHFT);
				val |= (1 << WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_PRI_DLY_INT_CFG0_PRI1_DLY_INT_EN_SHFT);
				RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_PRI_DLY_INT_CFG0_ADDR, val);
			} else {
				RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_ADDR, &val);
				val &= ~WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_PRI1_MAX_PTIME_MASK;
				val |= (2 << WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_PRI1_MAX_PTIME_SHFT);
				val &= ~WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_PRI1_MAX_PINT_MASK;
				val |= (127 << WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_PRI1_MAX_PINT_SHFT);
				val |= (1 << WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_PRI1_DLY_INT_EN_SHFT);
				RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_PRI_DLY_INT_CFG1_ADDR, val);
			}
		}
	}
...
static BOOLEAN hif_wait_WFDMA_idle(struct _RTMP_ADAPTER *pAd, UINT8 pcie_port_or_all, INT round, INT wait_us)
{
	...
	/* configure PCIe 1 host dma if it's in use, check if recognition ID is written */
	if ((MT7916_get_rid_value() != DEFAULT_RID) && (band_idx_map & (1 << 1))) {
...
static VOID pci_fw_own_by_port(RTMP_ADAPTER *ad, UINT8 port_idx)
{
	...
	MTWF_DBG(ad, DBG_CAT_FW, DBG_SUBCAT_ALL, DBG_LVL_INFO, "%s: fw own to p(%d)\n", __func__, port_idx);
}
...
#define MAX_RETRY_CNT 4
	...
	do {
		...
		if (drv_own == TRUE) {
			MTWF_DBG(ad, DBG_CAT_FW, DBG_SUBCAT_ALL, DBG_LVL_ERROR, "%s: Return since p=%d already in driver own\n", __func__, port_idx);
			return ret;
		}
		...
		if (drv_own)
			MTWF_DBG(ad, DBG_CAT_FW, DBG_SUBCAT_ALL, DBG_LVL_INFO, "%s: success to clear p=%d fw own, from(%d): 1 is interrupt mode, 2 is polling mode.\n", __func__, port_idx, drv_own_from);
		else {
			MTWF_DBG(ad, DBG_CAT_FW, DBG_SUBCAT_ALL, DBG_LVL_INFO, "%s: fail to clear p=%d fw_own\n", __func__, port_idx);
...
static BOOLEAN fw_own_sts(RTMP_ADAPTER *ad)
{
	...
	if (IS_PCI_INF(ad)) {
		...
		if (slave_hif_chip)
			fw_own_sts &= fw_own_sts_by_port(ad, 1);
	}
...
static VOID mt7906_isr(struct pci_hif_chip *hif_chip)
{
	UINT32 IntSource = 0x00000000L;
#ifdef CONFIG_WIFI_MSI_SUPPORT
	UINT32 IntMsk = 0x00000000L;
#endif
...
#ifdef CONFIG_WIFI_MSI_SUPPORT
	HIF_IO_READ32(pAd->hdev_ctrl, MT_INT_MASK_CSR, &IntMsk);
	if (hif_chip->is_msi)
...
#ifdef CONFIG_WIFI_MSI_SUPPORT
	HIF_IO_WRITE32(pAd->hdev_ctrl, MT_INT_MASK_CSR, 0);
#else
	...
	HIF_IO_WRITE32(pAd->hdev_ctrl, MT_INT_SOURCE_CSR, IntSource);
#ifdef CONFIG_WIFI_MSI_SUPPORT
	HIF_IO_WRITE32(pAd->hdev_ctrl, MT_INT_MASK_CSR, IntMsk & (~IntSource) | MT_INT_RX_DATA);
#endif

	RTMP_INT_UNLOCK(&hif_chip->LockInterrupt, flags);
}

static VOID mt790A_isr_pcie1(struct pci_hif_chip *hif_chip)
{
	UINT32 IntSource = 0x00000000L;
#ifdef CONFIG_WIFI_MSI_SUPPORT
	UINT32 IntMsk = 0x00000000L;
...
#ifdef CONFIG_WIFI_MSI_SUPPORT
	HIF_IO_READ32(pAd->hdev_ctrl, MT_INT1_MASK_CSR, &IntMsk);
	if (hif_chip->is_msi)
		IntSource &= ~MT_INT1_RX_DATA;
#endif
	...
	if (IntSource & MT_INT1_TxCoherent)
		MTWF_DBG(pAd, DBG_CAT_HIF, CATHIF_PCI, DBG_LVL_INFO, ">>>TxCoherent<<<\n");

	if (IntSource & MT_INT1_RxCoherent)
		MTWF_DBG(pAd, DBG_CAT_HIF, CATHIF_PCI, DBG_LVL_INFO, ">>>RxCoherent<<<\n");

	RTMP_INT_LOCK(&hif_chip->LockInterrupt, flags);
#ifdef CONFIG_WIFI_MSI_SUPPORT
	HIF_IO_WRITE32(pAd->hdev_ctrl, MT_INT1_MASK_CSR, 0);
#else
	mt_int_disable(pAd, hif_chip, IntSource);
#endif
	...
	HIF_IO_WRITE32(pAd->hdev_ctrl, MT_INT1_SOURCE_CSR, IntSource);
#ifdef CONFIG_WIFI_MSI_SUPPORT
	HIF_IO_WRITE32(pAd->hdev_ctrl, MT_INT1_MASK_CSR, IntMsk & (~IntSource) | MT_INT1_RX_DATA);
#endif
...
#ifdef CONFIG_WIFI_MSI_SUPPORT
static VOID mt7906_msi_isr_message3(struct pci_hif_chip *hif_chip)
{
	UINT32 IntSource = 0x00000000L;
	struct _PCI_HIF_T *pci_hif = hif_chip->hif;
	struct _RTMP_ADAPTER *pAd = RTMP_OS_NETDEV_GET_PRIV(pci_hif->net_dev);
	...
	if (!RTMP_TEST_FLAG(pAd, fRTMP_ADAPTER_START_UP) ||
		...
		MTWF_DBG(pAd, DBG_CAT_HIF, CATHIF_PCI, DBG_LVL_ERROR,
			"fRTMP_ADAPTER_START_UP is not TRUE or fRTMP_ADAPTER_HALT_IN_PROGRESS\n");
		HIF_IO_WRITE32(pAd->hdev_ctrl, MT_INT_SOURCE_CSR,
			MT_INT_DMA0_R4_DONE);
...
static VOID mt7906_msi_isr_message4(struct pci_hif_chip *hif_chip)
{
	UINT32 IntSource = 0x00000000L;
	struct _PCI_HIF_T *pci_hif = hif_chip->hif;
	struct _RTMP_ADAPTER *pAd = RTMP_OS_NETDEV_GET_PRIV(pci_hif->net_dev);
	...
	if (!RTMP_TEST_FLAG(pAd, fRTMP_ADAPTER_START_UP) ||
		...
		HIF_IO_WRITE32(pAd->hdev_ctrl, MT_INT_SOURCE_CSR,
			MT_INT_DMA0_R5_DONE);
		HIF_IO_WRITE32(pAd->hdev_ctrl, MT_INT_MASK_CSR_W1C_DMA0_PCIE0,
			MT_INT_DMA0_R5_DONE);
		return;
	}
...
static VOID mt7906_msi_isr_message2_pcie1(struct pci_hif_chip *hif_chip)
{
	UINT32 IntSource = 0x00000000L;
	struct _PCI_HIF_T *pci_hif = hif_chip->hif;
	struct _RTMP_ADAPTER *pAd = RTMP_OS_NETDEV_GET_PRIV(pci_hif->net_dev);
	...
	if (!RTMP_TEST_FLAG(pAd, fRTMP_ADAPTER_START_UP) ||
		...
		MTWF_DBG(pAd, DBG_CAT_HIF, CATHIF_PCI, DBG_LVL_ERROR,
			"fRTMP_ADAPTER_START_UP is not TRUE or fRTMP_ADAPTER_HALT_IN_PROGRESS\n");
		HIF_IO_WRITE32(pAd->hdev_ctrl, MT_INT1_SOURCE_CSR,
			MT_INT1_DMA0_R5_DONE);
...
static INT32 hif_cfg_dly_int(VOID *hdev_ctrl, UINT32 idx, UINT16 dly_number, UINT16 dly_time)
{
	...
	switch(idx)
	{
		...
		case MT_DMA0_R3_PCI1_RING_BASE:
...
#ifdef CONFIG_WIFI_MSI_SUPPORT
			if (master_hif_chip->is_msi == FALSE) {
#endif
		...
		case MT_DMA0_R5_PCI1_RING_BASE:
#ifdef CONFIG_WIFI_MSI_SUPPORT
			if (master_hif_chip->is_msi == FALSE) {
#endif
				RTMP_IO_READ32(hdev_ctrl, WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_PRI_DLY_INT_CFG0_ADDR, &reg_val);
		...
		case MT_DMA0_T19_PCI1_RING_BASE:
...
static VOID chip_irq_init(RTMP_ADAPTER *pAd)
{
	 ...
	 */
	/* 1. WFDMA_HOST_INT_ENA bit28, handled in mt7916_hif_ctrl_chip_init */
	 ...
	 */
	/* 1. WFDMA_HOST_INT_ENA bit29, handled in mt7916_hif_ctrl_chip_init */
	...
	/* priority interrupt setting are required only when MSI or multiple interrupt cases */
#ifdef CONFIG_WTBL_MISS_DVT
	...
	if (master_hif_chip->is_msi) {
		...
		reg_val |= (WF_WFDMA_HOST_DMA0_WPDMA_INT_RX_PRI_SEL_WPDMA_INT_RX_RING4_PRI_SEL_MASK |
		...
		if (MT7916_get_rid_value() != DEFAULT_RID) {
			...
			reg_val |= (WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_INT_RX_PRI_SEL_WPDMA_INT_RX_RING5_PRI_SEL_MASK |
					WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_INT_RX_PRI_SEL_WPDMA_INT_RX_RING3_PRI_SEL_MASK);
		...
		reg_val |= (WF_WFDMA_HOST_DMA0_WPDMA_INT_TX_PRI_SEL_WPDMA_INT_TX_RING18_PRI_SEL_MASK |
				...
				WF_WFDMA_HOST_DMA0_WPDMA_INT_TX_PRI_SEL_WPDMA_INT_TX_RING20_PRI_SEL_MASK);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_INT_TX_PRI_SEL_ADDR, reg_val);

		if (MT7916_get_rid_value() != DEFAULT_RID) {
			RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_INT_TX_PRI_SEL_ADDR, &reg_val);
			reg_val |= (WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_INT_TX_PRI_SEL_WPDMA_INT_TX_RING19_PRI_SEL_MASK);
			RTMP_IO_WRITE32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_PCIE1_WPDMA_INT_TX_PRI_SEL_ADDR, reg_val);
		} else {
			RTMP_IO_READ32(pAd->hdev_ctrl, WF_WFDMA_HOST_DMA0_WPDMA_INT_TX_PRI_SEL_ADDR, &reg_val);
...
static VOID chip_cap_mcs_nss_init(struct mcs_nss_caps *mcs_nss)
{
	...
	for (txrx = 0; txrx < 2; txrx++) {
		mcs_nss->max_path[0][txrx] = 2; /* 2G 2x2 */
		mcs_nss->max_path[1][txrx] = 3; /* 5G 3x3 */
	}
...
static VOID pci_interrupt_disable(struct _RTMP_ADAPTER *ad)
{
	...
	if (MT7916_get_rid_value() != DEFAULT_RID) {
		RTMP_IO_WRITE32(ad->hdev_ctrl, MT_PCIE1_MAC_INT_ENABLE_ADDR, 0x0);
	}
#endif
...
static VOID pci_interrupt_enable(struct _RTMP_ADAPTER *ad)
{
	...
	/* Disable PCIE Low Power Mode */
	RTMP_IO_WRITE32(ad->hdev_ctrl, MT_PCIE_MAC_LOW_POWER_ADDR, 0x00000f0f);
	if (MT7916_get_rid_value() != DEFAULT_RID) {
		RTMP_IO_WRITE32(ad->hdev_ctrl, MT_PCIE1_MAC_INT_ENABLE_ADDR, 0x000000ff);
		RTMP_IO_WRITE32(ad->hdev_ctrl, MT_PCIE1_MAC_LOW_POWER_ADDR, 0x00000f0f);
	}
#endif
...
#ifdef WF_RESET_SUPPORT
static void mt7916_do_wifi_reset(RTMP_ADAPTER *ad)
{
...
static VOID pci_subsys_int_handler(RTMP_ADAPTER *ad, void *hif_chip_ptr)
{
	...
	if (MT7916_get_rid_value() != DEFAULT_RID) {
		...
		if (cr_val & HOST_FW_OWN_CLR_STAT_MASK) {
			...
			cr_val = HOST_FW_OWN_CLR_STAT_MASK;
			RTMP_IO_WRITE32(ad->hdev_ctrl, cr_addr, cr_val);
			MTWF_DBG(ad, DBG_CAT_HIF, CATHIF_PCI, DBG_LVL_INFO, "%s::DriverOwn1\n", __func__);
		}
	}
#endif /* CONFIG_FWOWN_SUPPORT */
...
static VOID pci_sw_int_handler(RTMP_ADAPTER *ad, void *hif_chip_ptr)
{
	...
	if (MT7916_get_rid_value() != DEFAULT_RID) {
		UINT32 int1_source = 0;

		RTMP_IO_READ32(ad->hdev_ctrl, WF_WFDMA_HOST_DMA0_PCIE1_MCU2HOST_SW_INT_STA_ADDR, &int1_source);
		if (int1_source & MT_SW_INT1_DRV_OWN) {
			RTMP_IO_WRITE32(ad->hdev_ctrl, WF_WFDMA_HOST_DMA0_PCIE1_MCU2HOST_SW_INT_STA_ADDR, MT_SW_INT1_DRV_OWN);
			pci_driver_own_by_port(ad, 1);
			MTWF_DBG(ad, DBG_CAT_HIF, CATHIF_PCI, DBG_LVL_INFO, "%s::SWI DriverOwn1\n", __func__);
		}
	}
#endif /* CONFIG_FWOWN_SUPPORT */
...
*
*/
static VOID mt7916_hif_chip_match(VOID *hdev_ctrl)
{
	struct _PCI_HIF_T *pci_hif = hc_get_hif_ctrl(hdev_ctrl);
	struct pci_hif_chip *master_hif_chip = pci_hif->main_hif_chip;
	...
	if (rid != DEFAULT_RID) {
		...
		if (rid != DEFAULT_RID) {
			...
			*/
			...
			device_id = slave_hif_chip->cfg.device_id&0x0000FFFF;
			if (slave_hif_chip && (device_id == 0x790A)) {
				multi_hif_entry_gid_set(slave_hif_chip, gid);
				multi_hif_entry_rid_set(slave_hif_chip, ++rid);
				pci_hif->slave_hif_chip = slave_hif_chip;
			} else {
				rid = 0;
				set_rid_value(master_hif_chip, rid);
				multi_hif_entry_rid_set(master_hif_chip, rid);
			}
		}
	}
...
*
*/
static VOID mt7916_hif_pci_data_ring_assign(VOID *hdev_ctrl, UINT8 *resrc_idx)
{
	struct _PCI_HIF_T *pci_hif = hc_get_hif_ctrl(hdev_ctrl);
...
static VOID mt7916_dump_ser_stat(RTMP_ADAPTER *pAd, UINT8 dump_lvl)
{
...
static VOID mt7916_tx_deley_parm_init(UCHAR tx_delay_mode, struct tx_delay_control *tx_delay_ctl)
{
...
INT32 mt7916_get_RxFELossComp_data(struct _RTMP_ADAPTER *pAd, VOID *pData)
{
	...
	if ((prFeLossComp != NULL) && (prFeLossComp->u1BandIdx < RAM_BAND_NUM)) {
		...
		for (u1AntIdx = 0; u1AntIdx < MAX_ANTENNA_NUM; u1AntIdx++) {
			i1MT7916RxFeLossComp[prFeLossComp->u1BandIdx][u1AntIdx] = prFeLossComp->i1FeLossComp[u1AntIdx];
		}
	}
 ...
 */
static VOID mt7916_txd_post_process(struct _RTMP_ADAPTER *pAd, UCHAR *tmac_info, MAC_TX_INFO *info, HTTRANSMIT_SETTING *pTransmit)
{
...
VOID mt7916_update_chip_cap(RTMP_ADAPTER *ad)
{
...
static VOID mt7916_wps_led_init(RTMP_ADAPTER *pAd)
{
	UINT32 IdMac, macVal = 0;

	if (IS_MT7916(pAd)) {
		/*for non-colgin setting, use gpio16 as wps led*/
		/*set pinmux to GPIO*/
		IdMac = 0x70000000 + 0x5058;
		RTMP_IO_READ32(pAd->hdev_ctrl, IdMac, &macVal);
		macVal &= ~(BIT3 | BIT2 | BIT1 | BIT0);
		macVal |= 0x5;
...
static INT mt7916_get_tfs_time(RTMP_ADAPTER *pAd, UINT32 *high_part, UINT32 *low_part, UCHAR HwBssidIdx)
{
	UINT32 Value = 0;
	UINT8 band_idx = 0;
	struct wifi_dev *wdev = NULL;
...
static INT mt7916_asic_rts_on_off(struct _RTMP_ADAPTER *ad, UCHAR band_idx, UINT32 rts_num, UINT32 rts_len, BOOLEAN rts_en)
{
	UINT32 cr;
	UINT32 value;
...
static INT mt7916_asic_set_agglimit(RTMP_ADAPTER *pAd, UCHAR band_idx, UCHAR ac, struct wifi_dev *wdev, UINT32 agg_limit)
{
	UINT32 cr;
	UINT32 value = 0;
	UINT8 wmm_set;
...
static INT mt7916_asic_set_rts_retrylimit(RTMP_ADAPTER *pAd, UCHAR band_idx, UINT32 limit)
{
	UINT32 cr;
	UINT32 value = 0;
...
#ifdef DOT11_VHT_AC
static INT mt7916_asic_set_rts_signal_ta(RTMP_ADAPTER *ad, UINT8 band_idx, BOOLEAN enable)
{
...
static UINT32 mt7916_get_mib_bcn_tx_cnt(RTMP_ADAPTER *pAd, UINT8 band_idx)
{
	UINT32 value = 0;
...
static VOID mt7916_nic_update_ampdu_counter(RTMP_ADAPTER *pAd, UCHAR BandIdx)
{
	/* for PER debug */
...
static VOID mt7916_update_raw_counter(RTMP_ADAPTER *pAd)
{
	UINT32 i;
#ifdef CONFIG_QA
	COUNTER_802_11 *wlanCounter;
	...
	for (i = 0; i < DBDC_BAND_NUM; i++)
		mt7916_nic_update_ampdu_counter(pAd, i);
...
#ifdef DBDC_MODE
static UCHAR MT7916BandGetByIdx(RTMP_ADAPTER *pAd, UCHAR BandIdx)
{
	switch (BandIdx) {
	case 0:
		return (RFIC_24GHZ);
...
#ifdef WF_RESET_SUPPORT
static VOID mt7916_heart_beat_check(struct _RTMP_ADAPTER *pAd)
{
...
static VOID mt7916_chipCap_init(struct _RTMP_ADAPTER *pAd, RTMP_CHIP_CAP *chip_cap)
{
	...
	chip_cap->tkn_info.token_tx_cnt = 9216;
	...
	chip_cap->EEPROM_DEFAULT_BIN = mt7916_get_default_bin_image(pAd);
...
#endif
#ifdef CONFIG_6G_SUPPORT
	chip_cap->ppdu.he6g_start_spacing = 0x4; /* 2us */
...
#ifdef DOT11_HE_AX
#ifdef WIFI_TWT_SUPPORT
	chip_cap->twt_hw_num = MT7916_TWT_HW_AGRT_MAX_NUM;
	chip_cap->twt_btwt_max_num = MT7916_TWT_HW_BTWT_MAX_NUM;
	chip_cap->twt_group_max_num = MT7916_TWT_HW_GRP_MAX_NUM;
	chip_cap->twt_individual_max_num = (chip_cap->twt_hw_num - chip_cap->twt_btwt_max_num - chip_cap->twt_group_max_num);
	chip_cap->twt_sp_duration_min_num = MT7916_TWT_SP_DURATION_MIN_NUM;
#endif /* WIFI_TWT_SUPPORT */
	chip_cap->mu_edca_timer = 255;
#endif /* DOT11_HE_AX */
	if (MT7916_MT_WTBL_SIZE <= MAX_LEN_OF_MAC_TABLE)
		chip_cap->wtbl_max_entries = MT7916_MT_WTBL_SIZE;
	else
	...
	chip_cap->single_sku_fill_tbl_length = MT7916_SINGLE_SKU_FILL_TABLE_LENGTH;
	...
	chip_cap->spe_map_list.spe_map = mt7916_spe_map;
	chip_cap->spe_map_list.size = ARRAY_SIZE(mt7916_spe_map);
	...
	chip_cap->prek_ee_info.cal_result_size +  \
	...
	chip_cap->prek_ee_info.per_ch_6g_num = MT7916_PER_CH_A6_BW20_BW160_SIZE;
	chip_cap->prek_ee_info.per_ch_5g_num = MT7916_PER_CH_A5_BW20_BW160_SIZE;
	chip_cap->prek_ee_info.per_ch_2g_num = MT7916_PER_CH_G_BW20_SIZE;
...
static VOID mt7916_chipCap_post_init(struct _RTMP_ADAPTER *pAd, RTMP_CHIP_CAP *chip_cap)
{
	chip_cap->asic_caps |= fASIC_CAP_ADDBA_HW_SSN;
}

static UINT32 mt7916_get_sku_tbl_idx(RTMP_ADAPTER *pAd, UINT8 *sku_tbl_idx)
{
	UINT8 tbl_idx = 0;
...
static struct _RTMP_CHIP_OP mt7916_chip_op = { 0 };

static VOID mt7916_chipOp_init(struct _RTMP_ADAPTER *pAd, RTMP_CHIP_OP *chip_op)
{
	...
	chip_op->get_sku_tbl_idx = mt7916_get_sku_tbl_idx;
	/* BBP adjust */
...
#ifdef TXBF_SUPPORT
	chip_op->iBFPhaseComp			= mt7916_iBFPhaseComp;
	chip_op->iBFPhaseCalInit		= mt7916_iBFPhaseCalInit;
	chip_op->iBFPhaseFreeMem		= mt7916_iBFPhaseFreeMem;
	chip_op->iBFPhaseCalE2PUpdate	= mt7916_iBFPhaseCalE2PUpdate;
	chip_op->iBFPhaseCalReport		= mt7916_iBFPhaseCalReport;
	chip_op->iBfCaleBfPfmuMemAlloc	= mt7916_eBFPfmuMemAlloc;
	chip_op->iBfCaliBfPfmuMemAlloc	= mt7916_iBFPfmuMemAlloc;
	...
	chip_op->get_wf_path_comb = mt7916_get_wf_path_comb;
	chip_op->get_rx_stat_band = mt7916_get_rx_stat_band;
	chip_op->get_rx_stat_path = mt7916_get_rx_stat_path;
	chip_op->get_rx_stat_user = mt7916_get_rx_stat_user;
	chip_op->get_rx_stat_comm = mt7916_get_rx_stat_comm;
	chip_op->get_rx_stat = mt7916_get_rx_stat;
	chip_op->rxv_get_byte_cnt = mt7916_rxv_get_byte_cnt;
	chip_op->rxv_get_content = mt7916_rxv_get_content;
	chip_op->rxv_packet_parse = mt7916_rxv_packet_parse;
	chip_op->rxv_entry_parse = mt7916_rxv_entry_parse;
	chip_op->rxv_info_show = mt7916_rxv_info_show;
	chip_op->rxv_raw_data_show = mt7916_rxv_raw_data_show;
	chip_op->rxv_stat_reset = mt7916_rxv_stat_reset;
	chip_op->rxv_cap_init = mt7916_rxv_cap_init;
	chip_op->rxv_dump_start = mt7916_rxv_dump_start;
	chip_op->rxv_dump_stop = mt7916_rxv_dump_stop;
	chip_op->rxv_dump_buf_alloc = mt7916_rxv_dump_buf_alloc;
	chip_op->rxv_dump_buf_clear = mt7916_rxv_dump_buf_clear;
	chip_op->rxv_dump_show_list = mt7916_rxv_dump_show_list;
	chip_op->rxv_dump_show_rpt = mt7916_rxv_dump_show_rpt;
	chip_op->rxv_dump_rxv_content_compose = mt7916_rxv_dump_rxv_content_compose;
	chip_op->rxv_content_len = mt7916_rxv_content_len;
...
#endif
#ifdef DBDC_MODE
	chip_op->BandGetByIdx = MT7916BandGetByIdx;
#endif
#ifdef DOT11_HE_AX
#ifdef WIFI_TWT_SUPPORT
	...
	chip_op->hif_chip_match = mt7916_hif_chip_match;
	chip_op->hif_pci_data_ring_assign = mt7916_hif_pci_data_ring_assign;
...
#endif /* WIFI_UNIFIED_COMMAND */
#ifdef CONFIG_TX_DELAY
	chip_op->tx_deley_parm_init = mt7916_tx_deley_parm_init;
#endif
...
#endif
#ifdef WF_RESET_SUPPORT
	chip_op->heart_beat_check = mt7916_heart_beat_check;
	chip_op->do_wifi_reset = mt7916_do_wifi_reset;
#endif
#ifdef ERR_RECOVERY
	chip_op->dump_ser_stat = mt7916_dump_ser_stat;
#endif
#ifdef CFG_SUPPORT_FALCON_MURU
...
#endif /*SCS_FW_OFFLOAD*/
#endif /*SMART_CARRIER_SENSE_SUPPORT*/
	chip_op->get_RxFELossComp_data = mt7916_get_RxFELossComp_data;
...
#endif
#if defined(CONFIG_WLAN_SERVICE)
	chip_op->test_mode_dnlk = mt7916_ate_set_test_mode_dnlk;
#ifdef PRE_CAL_MT7916_SUPPORT
	chip_op->ate_group_prek = mt7916_ate_group_prek;
	chip_op->ate_dpd_prek = mt7916_ate_dpd_prek;
#endif
#endif
	chip_op->rssi_get = mt7916_rssi_get;
	chip_op->RAInit = mt7916_RAInit;
	chip_op->txpower_show_info = mtf_txpower_show_info;
	chip_op->update_mib_bucket = mt7916_update_mib_bucket;
	chip_op->ctrl_rxv_group = mt7916_ctrl_rxv_group;
	chip_op->get_bin_image_file = mt7916_get_default_bin_image_file;
#if defined(PRE_CAL_TRX_SET1_SUPPORT) || defined(PRE_CAL_TRX_SET2_SUPPORT) || defined(RLM_CAL_CACHE_SUPPORT)
	chip_op->get_prek_image_file = mt7916_get_prek_image_file;
#endif
	chip_op->set_mgmt_pkt_txpwr_prctg = mt7916_set_mgmt_pkt_txpwr_prctg;
#ifdef RTMP_EFUSE_SUPPORT
	chip_op->get_efuse_free_blk_bnum = mt7916_get_efuse_free_blk_num;
#endif
	chip_op->update_chip_cap = mt7916_update_chip_cap;
	chip_op->get_rid_value = MT7916_get_rid_value;
...
#ifdef LED_CONTROL_SUPPORT
	chip_op->wps_led_init = mt7916_wps_led_init;
	chip_op->wps_led_control = NULL;
#endif /*LED_CONTROL_SUPPORT*/
}

static VOID mt7916_archOp_init(RTMP_ADAPTER *ad, RTMP_ARCH_OP *arch_ops)
{
...
#ifdef MT7915_MT7916_COEXIST_COMPATIBLE
	arch_ops->asic_rts_on_off = mt7916_asic_rts_on_off;
	arch_ops->asic_set_agglimit = mt7916_asic_set_agglimit;
#else
...
#ifdef MT7915_MT7916_COEXIST_COMPATIBLE
	arch_ops->archGetTsfTime = mt7916_get_tfs_time;
#else
...
#ifdef MT7915_MT7916_COEXIST_COMPATIBLE
	arch_ops->update_raw_counters = mt7916_update_raw_counter;
#else
...
#ifdef DOT11_VHT_AC
#ifdef MT7915_MT7916_COEXIST_COMPATIBLE
	arch_ops->archSetRtsSignalTA = mt7916_asic_set_rts_signal_ta;
#else
...
#endif
#ifdef MT7915_MT7916_COEXIST_COMPATIBLE
	arch_ops->arch_get_bcn_tx_cnt = mt7916_get_mib_bcn_tx_cnt;
#else
...
#endif
	arch_ops->txd_post_process = mt7916_txd_post_process;

}

static VOID mt7916_chipOp_post_init(struct _RTMP_ADAPTER *pAd, RTMP_CHIP_OP *chip_op)
{
}


INT32 mt7916_get_chip_info(RTMP_ADAPTER *pAd)
{
	UINT32 value = 0;

	MAC_IO_READ32(pAd->hdev_ctrl, CBTOP_RESV_CID, &value);
	pAd->HWVersion = value;
...
VOID mt7916_init(RTMP_ADAPTER *pAd)
{
	...
	MTWF_PRINT("%s()-->\n", __func__);
	mt7916_chipCap_init(pAd, pChipCap);
	mt7916_chipOp_init(pAd, &mt7916_chip_op);
	hc_register_chip_ops(ctrl, &mt7916_chip_op);
	mt7916_archOp_init(pAd, arch_ops);
	mt7916_chip_dbg_init(chip_dbg);
	mt_phy_probe(pAd);
	mt7916_get_chip_info(pAd);
	mt7916_chipCap_post_init(pAd, pChipCap);
	mt7916_chipOp_post_init(pAd, chip_ops);
...
VOID mt7906_hif_ctrl_chip_init(VOID *hif_chip)
{
	...
	hif->int_enable_mask = (MT_INT_CoherentInt | MT_INT_DMA0_T16_DONE |
							...
							MT_INT_DMA0_T18_DONE | MT_INT_DMA0_T19_DONE);
	...
	hif->isr = mt7906_isr;
#ifdef CONFIG_WIFI_MSI_SUPPORT
	hif->msi_isr_message3 = mt7906_msi_isr_message3;
	hif->msi_isr_message4 = mt7906_msi_isr_message4;
#endif
...
VOID mt790A_hif_ctrl_chip_pcie1_init(VOID *hif_chip)
{
	...
	hif->isr = mt790A_isr_pcie1;
#ifdef CONFIG_WIFI_MSI_SUPPORT
	hif->msi_isr_message2_pcie1 = mt7906_msi_isr_message2_pcie1;
#endif
