...
#define DefaultBgndScanInterval                                                \
	1800 /* 30min.  The auto trigger interval shoulde more than this value */
...
typedef struct _BACKGROUND_SCAN_CTRL {
	...
	*/
	...
	BGND_SCAN_SUPP_CH_LIST BgndScanChList
		[MAX_NUM_OF_CHANNELS]; /* list all supported channels for background scan */
