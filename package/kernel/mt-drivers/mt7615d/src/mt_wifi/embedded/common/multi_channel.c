...
VOID Start_MCC(RTMP_ADAPTER *pAd)
{
	...
	if (pAd->Mlme.channel_1st_bw == HT_BW_20) {
		...
		pAd->Mlme.channel_1st_primary_ch = pAd->StaCfg[0].wdev.channel;
		pAd->Mlme.channel_1st_center_ch =
	...
	if (RTMP_CFG80211_VIF_P2P_GO_ON(pAd)) {
		...
		if (pAd->Mlme.channel_2nd_bw == HT_BW_20) {
			...
			pAd->Mlme.channel_2nd_primary_ch = p2p_wdev->channel;
			pAd->Mlme.channel_2nd_center_ch =
	...
	pAd->cfg80211_ctrl.GONoASchedule.StartTime =
		Lowpart + NextTbtt * 1024 + 204800 +
		(pAd->Mlme.channel_2nd_staytime * 512);
	MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_ERROR,
	...
	AsicMccStart(pAd, pAd->Mlme.channel_1st_primary_ch,
		     pAd->Mlme.channel_2nd_primary_ch, pAd->Mlme.channel_1st_bw,
		     pAd->Mlme.channel_2nd_bw, pAd->Mlme.channel_1st_center_ch,
		     0, pAd->Mlme.channel_2nd_center_ch, 0, 0, role,
		     pAd->Mlme.channel_1st_staytime,
		     pAd->Mlme.channel_2nd_staytime, pAd->Mlme.switch_idle_time,
		     1, pAd->cfg80211_ctrl.GONoASchedule.StartTime);
}
