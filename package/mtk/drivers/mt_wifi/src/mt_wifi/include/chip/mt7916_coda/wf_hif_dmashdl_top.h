...
//[Revision time]   : Fri Sep 25 23:02:37 2020
...
/* =====================================================================================
  ...
  ---WACPU_REFILL (0x7C026000 + 0x00)---
    ...
    WACPU_RETRUN_QID[22..16]     - (RW) WACPU refill queue ID, avaliable QID value is equal and below 0x23
...
/* =====================================================================================
  ...
  ---QUEUE_MAPPING4 (0x7C026000 + 0x84)---

    QUEUE32_MAPPING[3..0]        - (RW) Queue 32 use which group ID
    QUEUE33_MAPPING[7..4]        - (RW) Queue 33 use which group ID
    QUEUE34_MAPPING[11..8]       - (RW) Queue 34 use which group ID
    QUEUE35_MAPPING[15..12]      - (RW) Queue 35 use which group ID
    RESERVED16[31..16]           - (RO) Reserved bits
