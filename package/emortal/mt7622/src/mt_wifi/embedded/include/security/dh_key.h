...
extern void GenerateDHPublicKey(unsigned char *memPtr, unsigned char *ran_buf,
				int ran_len, unsigned char *dhkey,
				int *dhkey_len);

extern void GenerateDHSecreteKey(unsigned char *memPtr, unsigned char *ran_buf,
				 int ran_len, unsigned char *peer_dhkey,
				 int peer_dhkey_len,
				 unsigned char *secrete_dhkey,
