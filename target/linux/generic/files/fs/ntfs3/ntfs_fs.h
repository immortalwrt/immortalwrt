...
struct ntfs_inode {
	 ...
	 */
	u64 i_valid;
	struct timespec_compat i_crtime;
 ...
 */
static inline __le64 kernel2nt(const struct timespec_compat *ts)
{
 ...
 */
static inline void nt2kernel(const __le64 tm, struct timespec_compat *ts)
{
