...
#define WTBL_SET_MUARIDX(_x, _y)                                               \
	(_x = (_x & (~(0x3f << 16))) | (((_y)&0x3f) << 16))
...
#define WTBL_SET_PEER_ADDR5(_x, _y)                                            \
	(_x = (_x & (~(0xff << 8))) | (((_y)&0xff) << 8))
...
#define WTBL_SET_DIS_RHTR(_x, _y)                                              \
	(_x = (_x & (~(0x1 << 1))) | (((_y)&0x1) << 1))
#define WTBL_SET_WPI_EVEN(_x, _y)                                              \
	(_x = (_x & (~(0x1 << 2))) | (((_y)&0x1) << 2))
#define WTBL_SET_AAD_OM(_x, _y) (_x = (_x & (~(0x1 << 3))) | (((_y)&0x1) << 3))
#define WTBL_SET_CIPHER_SUIT(_x, _y)                                           \
	(_x = (_x & (~(0xf << 4))) | (((_y)&0xf) << 4))
#define WTBL_SET_PFMU_IDX(_x, _y)                                              \
	(_x = (_x & (~(0xff << 8))) | (((_y)&0xff) << 8))
#define WTBL_SET_PARTIAL_AID(_x, _y)                                           \
	(_x = (_x & (~(0x1ff << 16))) | (((_y)&0x1ff) << 16))
#define WTBL_SET_TIBF_HT(_x, _y)                                               \
	(_x = (_x & (~(0x1 << 25))) | (((_y)&0x1) << 25))
#define WTBL_SET_TEBF_HT(_x, _y)                                               \
	(_x = (_x & (~(0x1 << 26))) | (((_y)&0x1) << 26))
#define WTBL_SET_TIBF_VHT(_x, _y)                                              \
	(_x = (_x & (~(0x1 << 27))) | (((_y)&0x1) << 27))
#define WTBL_SET_TEBF_VHT(_x, _y)                                              \
	(_x = (_x & (~(0x1 << 28))) | (((_y)&0x1) << 28))
...
#define DMAC_WTBL_DW3_SET_BAF(_x, _y)                                          \
	(_x = ((_x) & (~0x00001000)) | (((_y)&0x1) << 12))
#define DMAC_WTBL_DW3_SET_RDGBA(_x, _y)                                        \
	(_x = ((_x) & (~0x00004000)) | (((_y)&0x1) << 14))
#define DMAC_WTBL_DW3_SET_R(_x, _y)                                            \
	(_x = ((_x) & (~0x00008000)) | (((_y)&0x1) << 15))
#define DMAC_WTBL_DW3_SET_SMPS(_x, _y)                                         \
	(_x = ((_x) & (~0x00800000)) | (((_y)&0x1) << 23))
#define DMAC_WTBL_DW3_SET_RTS(_x, _y)                                          \
	(_x = ((_x) & (~0x00400000)) | (((_y)&0x1) << 22))
#define DMAC_WTBL_DW3_SET_TXPS(_x, _y)                                         \
	(_x = ((_x) & (~0x00200000)) | (((_y)&0x1) << 21))
#define DMAC_WTBL_DW3_SET_AF(_x, _y)                                           \
	(_x = ((_x) & (~0x07000000)) | (((_y)&0x7) << 24))
#define DMAC_WTBL_DW3_SET_DU_IPSM(_x, _y)                                      \
	(_x = ((_x) & (~0x10000000)) | (((_y)&0x1) << 28))
#define DMAC_WTBL_DW3_SET_IPSM(_x, _y)                                         \
	(_x = ((_x) & (~0x20000000)) | (((_y)&0x1) << 29))
#ifdef RT_BIG_ENDIAN
union WTBL_DW3 {
	struct {
		UINT32 skip_tx : 1;
...
#define WTBL_SET_TXPWR_OFFSET(_x, _y)                                          \
	(_x = ((_x) & (~0x0000001f)) | (((_y)&0x1f) << 0))
#define WTBL_SET_FCAP(_x, _y) (_x = ((_x) & (~0x00003000)) | (((_y)&0x3) << 12))
#define WTBL_SET_LDPC(_x, _y) (_x = ((_x) & (~0x00004000)) | (((_y)&0x1) << 14))
#define WTBL_SET_LDPC_VHT(_x, _y)                                              \
	(_x = ((_x) & (~0x00008000)) | (((_y)&0x1) << 12))
...
#define WTBL_SET_RATE1(_x, _y)                                                 \
	(_x = ((_x) & (~0x00000fff)) | (((_y)&0xfff) << 0))
#define WTBL_SET_RATE2(_x, _y)                                                 \
	(_x = ((_x) & (~0x00fff000)) | (((_y)&0xfff) << 12))
#define WTBL_SET_RATE3_LOW(_x, _y)                                             \
	(_x = ((_x) & (~0xff000000)) | (((_y)&0xfff) << 24))
#define WTBL_SET_RATE3_HIGH(_x, _y)                                            \
	(_x = ((_x) & (~0x0000000f)) | ((((_y)&0xfff) >> 8) << 0))
#define WTBL_SET_RATE4(_x, _y)                                                 \
	(_x = ((_x) & (~0x0000fff0)) | (((_y)&0xfff) << 4))
#define WTBL_SET_RATE5(_x, _y)                                                 \
	(_x = ((_x) & (~0x0fff0000)) | (((_y)&0xfff) << 16))
#define WTBL_SET_RATE6_LOW(_x, _y)                                             \
	(_x = ((_x) & (~0xf0000000)) | (((_y)&0xfff) << 28))
#define WTBL_SET_RATE6_HIGH(_x, _y)                                            \
	(_x = ((_x) & (~0x000000ff)) | ((((_y)&0xfff) >> 4) << 0))
#define WTBL_SET_RATE7(_x, _y)                                                 \
	(_x = ((_x) & (~0x000fff00)) | (((_y)&0xfff) << 8))
#define WTBL_SET_RATE8(_x, _y)                                                 \
	(_x = ((_x) & (~0xfff00000)) | (((_y)&0xfff) << 20))
