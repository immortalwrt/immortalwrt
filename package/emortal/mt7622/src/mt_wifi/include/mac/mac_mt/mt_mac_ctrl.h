...
typedef struct _TXS_CTL {
	...
	NDIS_SPIN_LOCK TxSTypePerPktTypeLock[3]
...
INT32 TxSTypeCtlPerPkt(struct _RTMP_ADAPTER *pAd, UINT32 Pid, UINT8 Format,
		       ...
		       ULONG DumpTxSReportTimes);
INT32 ParseTxSPacket_v1(struct _RTMP_ADAPTER *pAd, UINT32 Pid, UINT8 Format,
			CHAR *Data);
INT32 ParseTxSPacket_v2(struct _RTMP_ADAPTER *pAd, UINT32 Pid, UINT8 Format,
			CHAR *Data);
...
INT32 RemoveTxSTypePerPktType(struct _RTMP_ADAPTER *pAd, UINT8 Type,
			      UINT8 Subtype, UINT8 Format);
INT32 TxSTypeCtlPerPktType(struct _RTMP_ADAPTER *pAd, UINT8 Type, UINT8 Subtype,
			   UINT16 WlanIdx, UINT8 Format, BOOLEAN TxS2Mcu,
			   BOOLEAN TxS2Host, BOOLEAN DumpTxSReport,
			   ULONG DumpTxSReportTimes);
UINT8 AddTxSStatus(struct _RTMP_ADAPTER *pAd, UINT8 Type, UINT8 PktPid,
		   UINT8 PktType, UINT8 PktSubType, UINT16 TxRate, UINT32 Priv);
INT32 RemoveTxSStatus(struct _RTMP_ADAPTER *pAd, UINT8 TxSPid, UINT8 *Type,
		      UINT8 *PktPid, UINT8 *PktType, UINT8 *PktSubType,
		      UINT16 *TxRate, UINT32 *Priv);
