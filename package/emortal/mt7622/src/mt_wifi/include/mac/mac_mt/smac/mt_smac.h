...
#define MT_TOP_REMAP_ADDR                                                      \
	0x80000000 /* TOP start address 8002-0000, but only can remap to 8000-0000 */
#define MT_TOP_REMAP_ADDR_THEMAL                                               \
	0xa2000 /* Get Thermal sensor adc cal value: 0x80022000 bits(8,14), Offset 0x80000 + 0x22000 = 0xa2000 */
#define MT_TOP_THEMAL_ADC                                                      \
	0x80022000 /* Get Thermal sensor adc cal value: 0x80022000 bits(8,14) */
...
VOID mt_write_tmac_info(struct _RTMP_ADAPTER *pAd, UCHAR *buf,
			struct _TX_BLK *pTxBlk);
INT mt_hw_tx(struct _RTMP_ADAPTER *pAd, struct _TX_BLK *tx_blk);
INT mt_mlme_hw_tx(struct _RTMP_ADAPTER *pAd, UCHAR *tmac_info,
		  struct _MAC_TX_INFO *info, HTTRANSMIT_SETTING *transmit,
