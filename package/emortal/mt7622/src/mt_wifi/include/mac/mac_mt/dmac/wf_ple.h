...
} ENUM_UMAC_CPU_P_QUEUE_T,
	*P_ENUM_UMAC_CPU_P_QUEUE_T;
...
} ENUM_UMAC_LMAC_TX_P_QUEUE_T,
	*P_ENUM_UMAC_LMAC_TX_P_QUEUE_T;
...
} ENUM_UMAC_PLE_CTRL_P3_QUEUE_T,
	*P_ENUM_UMAC_PLE_CTRL_P3_QUEUE_T;
