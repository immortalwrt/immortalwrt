...
/* 802.11mc D3.0: 8.4.2.20.10 (p.744) */
enum AZIMUTH_TYPE { AZTYPE_RADIO_RECEPTION = 0, AZTYPE_FRONT_SURFACE = 1 };
...
*/
enum MEASUREMENT_TYPE_REPORT { MSMT_LCI_RPT = 8, MSMT_LOCATION_CIVIC_RPT = 11 };
...
*/
enum FTM_REQ_TRIGGER_CODE { FTM_TRIGGER_STOP, FTM_TRIGGER_START_OR_CONTI };

enum FTM_TX_REASON { FTMTX_START, FTMTX_ONGOING, FTMTX_STOP };
