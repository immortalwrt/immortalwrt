...
#define RT_PRIV_IOCTL_EXT                                                      \
	(SIOCIWFIRSTPRIV + 0x0E) /* Sync. with RT61 (for wpa_supplicant) */
...
#define RTPRIV_IOCTL_RX_STATISTICS                                             \
	(SIOCIWFIRSTPRIV + 0x1B) /* Get CMD ID is odd; Set CMD ID is even */
#define MTPRIV_IOCTL_RD                                                        \
	(SIOCIWFIRSTPRIV + 0x17) /* modified by CT@MediaTek, 2017/04/11 */
