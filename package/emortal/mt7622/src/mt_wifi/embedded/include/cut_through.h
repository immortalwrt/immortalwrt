...
#ifdef WHNAT_SUPPORT
#define DEFAUT_WHNAT_PKT_TX_TOKEN_ID_MAX                                       \
	1023 /* token ID in range of 0~2047 for SW path */
#endif
#define CUT_THROUGH_TX_ENABL(_ptr)                                             \
	((((PKT_TOKEN_CB *)(_ptr))->cut_through_type & CUT_THROUGH_TYPE_TX) == \
	 CUT_THROUGH_TYPE_TX)
#define CUT_THROUGH_RX_ENABL(_ptr)                                             \
	((((PKT_TOKEN_CB *)(_ptr))->cut_through_type & CUT_THROUGH_TYPE_RX) == \
	 CUT_THROUGH_TYPE_RX)
