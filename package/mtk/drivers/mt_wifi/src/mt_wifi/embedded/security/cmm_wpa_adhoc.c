	...
	OUT	PUCHAR			pTxTsc)
{
	...
	*(pTxTsc + 5) = EIV & 0xff000000;
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "(): WCID(%d) TxTsc 0x%02x-0x%02x-0x%02x-0x%02x-0x%02x-0x%02x\n",
	...
	IN MLME_QUEUE_ELEM * Elem)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "Adhoc_WpaEAPOLStartAction ===>\n");
	...
	if (pEntry) {
		...
		MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, " PortSecured(%d), WpaState(%d), AuthMode(%d), is_cache(%d)\n",
	...
	IN MLME_QUEUE_ELEM * Elem)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "Adhoc_WpaEAPOLKeyAction ===>\n");
	pHeader = (PHEADER_802_11)Elem->Msg;
	...
	*((USHORT *)&peerKeyInfo) = cpu2le16(*((USHORT *)&peerKeyInfo));
	...
	do {
		...
		MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "Receive EAPoL-Key frame from STA %02X-%02X-%02X-%02X-%02X-%02X\n", PRINT_MAC(pEntry->Addr));
	...
	IN ULONG			TimeInterval)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "===> Adhoc_WpaStart4WayHS\n");
	...
	pAuthenticator->WpaState = AS_PTKSTART;
	os_free_mem(mpool);
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "<=== Adhoc_WpaStart4WayHS: send Msg1 of 4-way\n");
}
	...
	IN MLME_QUEUE_ELEM * Elem)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "===> Adhoc_PeerPairMsg1Action\n");
	...
	RTMPToWirelessSta(pAd, pEntry,
					  ...
					  (tr_entry->PortSecured == WPA_802_1X_PORT_SECURED) ? FALSE : TRUE);
	os_free_mem(mpool);
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "<=== PeerPairMsg1Action: send Msg2 of 4-way\n");
}
	...
	IN MLME_QUEUE_ELEM * Elem)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "===> Adhoc_PeerPairMsg2Action\n");
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "<=== PeerPairMsg2Action: send Msg3 of 4-way\n");
}
	...
	IN MLME_QUEUE_ELEM * Elem)
{
	...
	if (pEntry->AuthMode == Ndis802_11AuthModeWPA2PSK ||
		...
		MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "PeerPairMsg3Action: AuthMode(%s) PairwiseCipher(%s) GroupCipher(%s)\n",
	...
	os_free_mem(mpool);
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "<=== PeerPairMsg3Action: send Msg4 of 4-way\n");
}
	...
	IN MLME_QUEUE_ELEM * Elem)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "===> Adhoc_PeerPairMsg4Action\n");
	...
	IN MLME_QUEUE_ELEM * Elem)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "PeerGroupMsg1Action: AuthMode(%s) PairwiseCipher(%s) GroupCipher(%s)\n",
			 GetAuthMode(pEntry->AuthMode),
			 GetEncryptType(pEntry->WepStatus),
			 GetEncryptType(group_cipher));
	...
	os_free_mem(mpool);
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "<=== PeerGroupMsg1Action: send group message 2\n");
}
	...
	IN MAC_TABLE_ENTRY  *pEntry)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "===> Adhoc_Wpa4WayComplete\n");
	...
	IN PVOID SystemSpecific3)
{
	...
	if ((pEntry) && IS_ENTRY_CLIENT(pEntry)) {
		...
		ASSERT(pStaCfg);
		MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "Adhoc_WPARetryExec---> ReTryCounter=%d, WpaState=%d\n", pAuthenticator->MsgRetryCounter, pAuthenticator->WpaState);
		...
		case Ndis802_11AuthModeWPA2PSK:
			if (pAuthenticator->MsgRetryCounter == 0) {
				...
				if ((pAuthenticator->WpaState == AS_PTKSTART) || (pAuthenticator->WpaState == AS_INITPSK) || (pAuthenticator->WpaState == AS_INITPMK)) {
					MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "Adhoc_WPARetryExec::ReTry MSG1 of 4-way Handshake\n");
					Adhoc_WpaStart4WayHS(pAd, pEntry, PEER_MSG1_RETRY_EXEC_INTV);
				}
				...
				{
					MlmeDeAuthAction(pAd, pEntry, REASON_4_WAY_TIMEOUT, FALSE);
					MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "Adhoc_WPARetryExec::Retry MSG3, TIMEOUT\n");
				}
			}
	...
	OUT PEAPOL_PACKET       pMsg)
{
	...
	*(USHORT *)(pKeyInfo) = cpu2le16(*(USHORT *)(pKeyInfo));
	...
	MTWF_DBG(NULL, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "===> ConstructEapolMsg for %s %s\n", ((bWPA2) ? "WPA2" : "WPA"), GetEapolMsgType(MsgType));
	MTWF_DBG(NULL, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "	     Body length = %d\n", CONV_ARRARY_TO_UINT16(pMsg->Body_Len));
	MTWF_DBG(NULL, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, "	     Key length  = %d\n", CONV_ARRARY_TO_UINT16(pKeyDesc->KeyLength));
}
