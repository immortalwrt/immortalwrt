...
#define ERROR_DETECT_MASK                                                      \
	(ERROR_DETECT_STOP_PDMA_WITH_FW_RELOAD | ERROR_DETECT_STOP_PDMA |      \
	 ERROR_DETECT_RESET_DONE | ERROR_DETECT_RECOVERY_DONE |                \
	 ERROR_DETECT_N9_NORMAL_STATE | ERROR_DETECT_LMAC_ERROR |              \
	 ERROR_DETECT_PSE_ERROR | ERROR_DETECT_PLE_ERROR |                     \
	 ERROR_DETECT_PDMA_ERROR | ERROR_DETECT_PCIE_ERROR)
#endif
...
#define MT_INT_TX_DONE                                                         \
	(MT_INT_T0_DONE | MT_INT_T1_DONE | MT_INT_T2_DONE | MT_INT_T3_DONE |   \
	 MT_INT_T4_DONE | MT_INT_T5_DONE | MT_INT_T6_DONE | MT_INT_T7_DONE |   \
	 MT_INT_T8_DONE | MT_INT_T9_DONE | MT_INT_T10_DONE | MT_INT_T11_DONE | \
	 MT_INT_T12_DONE | MT_INT_T13_DONE | MT_INT_T14_DONE |                 \
	 MT_INT_T15_DONE)
...
#define MT_RxINT                                                               \
	(MT_INT_R0_DONE |                                                      \
	 MT_INT_R1_DONE /* | MT_INT_RX_DLY */) /* Delayed Rx or indivi rx */
...
#define MT_MacInt                                                              \
	(WF_MAC_INT_0 | WF_MAC_INT_1 | WF_MAC_INT_2 | WF_MAC_INT_3 |           \
...
typedef struct _PCI_HIF_T {
	...
	RTMP_TX_RING *TxRing;
	BOOLEAN(*dma_done_handle[PACKET_TYPE_NUM])
...
#ifdef MT_MAC
	RTMP_DMABUF
	TxBmcBufSpace; /* Shared memory of all 1st pre-allocated TxBuf associated with each TXD */
...
#define GET_TX_RING0_DMAD_PRE_HI_PRI_NUM(p)                                    \
	(((p)&TX_RING0_DMAD_PRE_HI_PRI_NUM_MASK) >> 16)
#define TX_RING1_DMAD_PRE_HI_PRI_NUM_MASK (0x3 << 18)
#define TX_RING1_DMAD_PRE_HI_PRI_NUM(p) (((p)&0x3) << 18)
#define GET_TX_RING1_DMAD_PRE_HI_PRI_NUM(p)                                    \
	(((p)&TX_RING1_DMAD_PRE_HI_PRI_NUM_MASK) >> 18)
...
#define GET_RX_RING0_DMAD_PRE_HI_PRI_NUM(p)                                    \
	(((p)&RX_RING0_DMAD_PRE_HI_PRI_NUM_MASK) >> 16)
#define RX_RING1_DMAD_PRE_HI_PRI_NUM_MASK (0xf << 24)
#define RX_RING1_DMAD_PRE_HI_PRI_NUM(p) (((p)&0xf) << 24)
#define GET_RX_RING1_DMAD_PRE_HI_PRI_NUM(p)                                    \
	(((p)&RX_RING1_DMAD_PRE_HI_PRI_NUM_MASK) >> 24)
...
#define GET_PDMA_DFET_PFET_ABT_W_FULL_IN_DIS(p)                                \
	(((p)&PDMA_DFET_PFET_ABT_W_FULL_IN_DIS_MASK) >> 6)
