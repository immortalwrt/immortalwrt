	...
	"2c7c" )
		case $uPid in
			...
			"0801" ) #RM520
				...
				M5='1100101100011100000100001101110000000101000000010000000000000000010000100'
				M6='1100101100011100000100001101110000000101000000010000000000000000010000100'
				CA=""
				CA3=""
			;;
			"0800"|"0900" ) # RM500
				f2=$(echo $model | grep "502")
				if [ ! -z "$f2" ]; then
					M2='1111101100011100011100001101110101000111110000000000000000000000010000100'
					M5='0000000000000000000000000000000000000100100000000000000000000000000000000000111'
					M6='1110101100010000000100001001000000000101100000010000000000000000010000100000111'
				else
					...
					if [ ! -z "$GL" ]; then #RM500-GL
						...
						M2='1111101100011100111100001101110101000111111000010000000000000000010000100'
						M5='1110101100010000000100001001000000000101100000000000000000000000010000100000111'
						M6='1110101100010000000100001001000000000101100000010000000000000000010000100000111'
					fi
				fi
				CA=""
