...
*/
#ifdef DOT11_VHT_AC
#define MAX_NUM_OF_CHS                                                         \
	(54 + 5) /* 5 channels for central channel of VHT 80MHz */
#else
...
#define MAX_NUM_OF_SUB_CHANNELS                                                \
	(MAX_NUM_OF_CHANNELS / 2) /*Assume half size for sub channels*/
#endif
...
#define OPMODE_AP 1
#define OPMODE_ADHOC                                                           \
	2 /*Carter add, align the number definition as MT hw arb module. */
...
#define SWAP64(x)                                                              \
	((UINT64)((UINT64)(((UINT64)(x) & (UINT64)0x00000000000000ffULL)       \
			   << 56) |                                            \
		  (UINT64)(((UINT64)(x) & (UINT64)0x000000000000ff00ULL)       \
			   << 40) |                                            \
		  (UINT64)(((UINT64)(x) & (UINT64)0x0000000000ff0000ULL)       \
			   << 24) |                                            \
		  (UINT64)(((UINT64)(x) & (UINT64)0x00000000ff000000ULL)       \
			   << 8) |                                             \
		  (UINT64)(((UINT64)(x) & (UINT64)0x000000ff00000000ULL) >>    \
			   8) |                                                \
		  (UINT64)(((UINT64)(x) & (UINT64)0x0000ff0000000000ULL) >>    \
			   24) |                                               \
		  (UINT64)(((UINT64)(x) & (UINT64)0x00ff000000000000ULL) >>    \
			   40) |                                               \
		  (UINT64)(((UINT64)(x) & (UINT64)0xff00000000000000ULL) >>    \
			   56)))
...
#define MEM_DBG_PKT_ALLOC_INC(__pPacket)                                       \
	{                                                                      \
		MIListAddHead(&PktInfoList, 0, __pPacket,                      \
