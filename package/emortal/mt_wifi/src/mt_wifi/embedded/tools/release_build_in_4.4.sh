...
if [ -d mt_wifi ]; then
    ...
    mkdir -p mt_wifi_ap
    mkdir -p mt_wifi_sta
    cp -a  mt_wifi/os/linux/Kconfig.mt_wifi_ap ./mt_wifi_ap/Kconfig
    cp -a  mt_wifi/os/linux/Makefile.mt_wifi_ap ./mt_wifi_ap/Makefile
    cp -a  mt_wifi/os/linux/Kconfig.mt_wifi_sta ./mt_wifi_sta/Kconfig
    cp -a  mt_wifi/os/linux/Makefile.mt_wifi_sta ./mt_wifi_sta/Makefile
    cp -a mt_wifi/os/linux/Kconfig.mt_wifi_4_4 mt_wifi/embedded/Kconfig
