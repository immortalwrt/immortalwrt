...
VERSION_REPO:=$(if $(VERSION_REPO),$(VERSION_REPO),https://immortalwrt.kyarucloud.moe/snapshots)
...
VERSION_FIRMWARE_URL:=$(if $(VERSION_FIRMWARE_URL),$(VERSION_FIRMWARE_URL),https://immortalwrt.kyarucloud.moe/)
