...
VERSION_CODE:=$(if $(VERSION_CODE),$(VERSION_CODE),r28315-27c9bdb28c7a)

VERSION_REPO:=$(call qstrip,$(CONFIG_VERSION_REPO))
VERSION_REPO:=$(if $(VERSION_REPO),$(VERSION_REPO),https://downloads.immortalwrt.org/releases/23.05.6)
