...
/* DW5 PPDU Format */
#define TXS_PPDU_MPDU_TX_BYTE_MASK (0xffffff)
#define TXS_PPDU_MPDU_TX_BYTE_SHIFT 0
#define TXS_PPDU_MPDU_TX_CNT_MASK (0xff << 24)
#define TXS_PPDU_MPDU_TX_CNT_SHIFT 24
...
/* DW6 PPDU Format */
#define TXS_PPDU_MPDU_FAIL_BYTE_MASK (0xffffff)
#define TXS_PPDU_MPDU_FAIL_BYTE_SHIFT 0
#define TXS_PPDU_MPDU_FAIL_CNT_MASK (0xff << 24)
#define TXS_PPDU_MPDU_FAIL_CNT_SHIFT 24
...
/* DW7 PPDU Format */
#define TXS_PPDU_MPDU_RTY_BYTE_MASK (0xffffff)
#define TXS_PPDU_MPDU_RTY_BYTE_SHIFT 0
#define TXS_PPDU_MPDU_RTY_CNT_MASK (0xff << 24)
#define TXS_PPDU_MPDU_RTY_CNT_SHIFT 24
