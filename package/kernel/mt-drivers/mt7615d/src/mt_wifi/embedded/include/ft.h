...
#define IS_FT_STA(__A)                                                         \
	(((__A) && ((__A)->MdIeInfo.Len != 0) &&                               \
	  IS_AKM_OPEN(__A->SecConfig.AKMMap)) ||                               \
	 IS_FT_RSN_STA(__A))
...
#define FT_KDP_IOCTL_KEY_REQ(__pAd, __pInfo, __InfoLen)                        \
	{                                                                      \
		...
		FT_KDP_KeyRequestToUs(                                         \
			__pAd, __PeerIP, (__pInfo) + FT_IP_ADDRESS_SIZE,       \
			(FT_KDP_EVT_KEY_ELM *)((__pInfo) +                     \
					       FT_IP_ADDRESS_SIZE +            \
					       FT_NONCE_SIZE));                \
	}

/* Macros relative to R1KH Table. */
#define FT_R1NAME_HASH(_Data)                                                  \
	(_Data[0] ^ _Data[1] ^ _Data[2] ^ _Data[3] ^ _Data[4] ^ _Data[5] ^     \
	 _Data[6] ^ _Data[7] ^ _Data[8] ^ _Data[9] ^ _Data[10] ^ _Data[11] ^   \
	 _Data[12] ^ _Data[13] ^ _Data[14] ^ _Data[15])
#define FT_R1KH_HASH_INDEX(_Data)                                              \
	(FT_R1NAME_HASH(_Data) % (FT_R1KH_ENTRY_HASH_TABLE_SIZE))
/* YF_FT */
enum _FT_FSM_STATUS {
	TX_AUTH_RSP = 1,
	TX_AUTH_ACK,
...
/* event */
#define FT_KDP_EVENT_INFORM(__pAd, __ApIdx, __EventId, __pEvent, __EventLen,   \
			    __CB)                                              \
	FT_KDP_EventInform(__pAd, __ApIdx, __EventId, (VOID *)__pEvent,        \
			   __EventLen, 0, __CB)
...
========================================================================
*/
VOID FT_KDP_Init(IN PRTMP_ADAPTER pAd);
...
========================================================================
*/
VOID FT_KDP_Release(IN PRTMP_ADAPTER pAd);
...
========================================================================
*/
VOID FT_KDP_EventGet(IN PRTMP_ADAPTER pAd, OUT FT_KDP_SIGNAL **pFtKdp);
...
========================================================================
*/
VOID FT_KDP_EventInform(IN PRTMP_ADAPTER pAd, IN UINT32 ApIdx, IN UCHAR EventId,
			IN VOID *pEvent, IN UINT16 EventLen, IN UINT32 PeerIP,
			IN VOID *pCB);
...
========================================================================
*/
BOOLEAN FT_KDP_KeyRequestToUs(IN PRTMP_ADAPTER pAd, IN UINT32 PeerIP,
			      IN UCHAR *pNonce,
...
========================================================================
*/
VOID FT_KDP_KeyResponseToUs(IN PRTMP_ADAPTER pAd, IN UINT8 *pInfo,
			    IN INT32 InfoLen);
...
========================================================================
*/
VOID FT_KDP_StationInform(IN PRTMP_ADAPTER pAd, IN UINT8 *pInfo,
			  IN INT32 InfoLen);
...
========================================================================
*/
VOID FT_KDP_CryptKeySet(IN PRTMP_ADAPTER pAd, IN UCHAR *pKey, IN INT32 KeyLen);
...
========================================================================
*/
VOID FT_KDP_DataEncrypt(IN PRTMP_ADAPTER pAd, INOUT UCHAR *pData,
			IN UINT32 *pDataLen);
...
========================================================================
*/
VOID FT_KDP_DataDecrypt(IN PRTMP_ADAPTER pAd, IN UCHAR *pData,
			IN UINT32 *pDataLen);
...
========================================================================
*/
VOID FT_KDP_InfoBroadcast(IN PVOID SystemSpecific1, IN PVOID FunctionContext,
...
========================================================================
*/
VOID FT_KDP_NeighborRequestHandle(IN PRTMP_ADAPTER pAd, IN UCHAR *pInfo,
				  IN INT32 InfoLen);
...
========================================================================
*/
VOID FT_KDP_NeighborResponseHandle(IN PRTMP_ADAPTER pAd, IN UCHAR *pInfo,
				   IN INT32 InfoLen);
...
========================================================================
*/
VOID FT_RRB_ActionHandle(IN PRTMP_ADAPTER pAd, IN INT32 ApIdx, IN UCHAR *pInfo,
			 IN INT32 InfoLen);
...
========================================================================
*/
VOID FT_RIC_Init(IN PRTMP_ADAPTER pAd);
...
========================================================================
*/
VOID FT_RIC_Release(IN PRTMP_ADAPTER pAd);
...
========================================================================
*/
VOID FT_InsertMdIE(IN PRTMP_ADAPTER pAd, OUT PUCHAR pFrameBuf,
		   OUT PULONG pFrameLen, IN PUINT8 pMdId,
...
========================================================================
*/
VOID FT_EnqueueAuthReply(IN PRTMP_ADAPTER pAd, IN PHEADER_802_11 pRcvHdr,
...
========================================================================
*/
VOID FT_KDP_KeyResponse(IN PRTMP_ADAPTER pAd, IN UCHAR *pInfo,
			IN INT32 InfoLen);
...
========================================================================
*/
UINT32 FT_RIC_ResourceRequestHandle(IN PRTMP_ADAPTER pAd,
				    IN MAC_TABLE_ENTRY *pCdb, IN UCHAR *pBufReq,
				    IN UINT32 ReqLen, OUT UCHAR *pBufRsp,
				    OUT UINT32 *pRspLen);
...
========================================================================
*/
VOID FT_InsertFTIE(IN PRTMP_ADAPTER pAd, OUT PUCHAR pFrameBuf,
		   OUT PULONG pFrameLen, IN UINT8 Length,
		   IN FT_MIC_CTR_FIELD MICCtr, IN PUINT8 pMic,
		   IN PUINT8 pANonce, IN PUINT8 pSNonce);
...
========================================================================
*/
VOID FT_FTIE_InsertKhIdSubIE(IN PRTMP_ADAPTER pAd, OUT PUCHAR pFrameBuf,
			     OUT PULONG pFrameLen, IN FT_SUB_ELEMENT_ID SubId,
			     IN PUINT8 pKhId, IN UINT8 KhIdLen);
...
========================================================================
*/
VOID FT_FTIE_InsertGTKSubIE(IN PRTMP_ADAPTER pAd, IN PUCHAR pFrameBuf,
			    OUT PULONG pFrameLen, IN PUINT8 pGtkSubIe,
			    IN UINT8 GtkSubIe_len);

VOID FT_FTIE_InsertIGTKSubIE(IN PRTMP_ADAPTER pAd, IN PUCHAR pFrameBuf,
			     OUT PULONG pFrameLen, IN PUINT8 pGtkSubIe,
			     IN UINT8 GtkSubIe_len);
...
========================================================================
*/
VOID FT_InsertTimeoutIntervalIE(OUT PUCHAR pFrameBuf, OUT PULONG pFrameLen,
...
INT FT_R1khEntryInsert(IN PRTMP_ADAPTER pAd, IN PUINT8 pPmkR0Name,
		       ...
		       IN PUINT8 pR0khId, IN UINT8 R0khIdLen,
		       IN PUINT8 pStaMac);
...
========================================================================
*/
PFT_R1HK_ENTRY FT_R1khEntryTabLookup(IN PRTMP_ADAPTER pAd,
