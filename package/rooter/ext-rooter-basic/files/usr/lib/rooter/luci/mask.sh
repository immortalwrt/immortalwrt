		...
		case $uPid in
			...
			"0801" ) #RM520
				...
				if [ ! -z "$GL" ]; then #RM520N-GL
					...
					M5='11101011000111000101000011011100000001011000000100000000000000000100001000111110'
					M6=$M5
					CA=""
					CA3=""
				else #RM520N-EU
					M2='1010101100000000000100000001000100000101111000000000000000000000000000100'
			...
			"0800") # RM500
				...
				if [ -z "$f2" ]; then #RM502/505/510
					M2='1111101100011100011100001101110101000111111000010000000000000000010000100'
					M5='1110101100010000000100001001000000000101100000010000000000000000010000100000111'
					M6=$M5
				else
					GL=$(echo $model | grep "GL")
