...
/* TWT tsf type to CMD */
#define CMD_TST_TYPE_SCHEDULE        0
#define CMD_TSF_TYPE_REQUESTER       1
#define CMD_TSF_TYPE_TWT_INFO        2
#define CMD_TSF_TYPE_NA              3
...
/* TWT element -> bTWT */
#define SET_TWT_BTWT_ID(btwt_id) \
	(((btwt_id) << BTWT_INFO_BTWT_ID_OFFSET) & \
		BTWT_INFO_BTWT_ID)

#define SET_TWT_BTWT_P(p) \
